...
export const LoggingComponent: React.FC<LogProps> = ({
  logs,
  onTopReached,
  onBottomReached,
  autoScroll = true,
  ...
  return (
    <div
      className="w-full mx-auto overflow-y-auto p-4  font-mono text-xs rounded-md min-h-[25rem] bg-muted"
      ref={containerRef}
...
// source: httpb.com/bryc/code/blob/mas=> ter/jshash/experimental/cyrb53.js
