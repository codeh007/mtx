...
const MtTabs = TabsPrimitive.Root;
...
const MtTabsList = React.forwardRef<
...
MtTabsList.displayName = TabsPrimitive.List.displayName;
...
const MtTabsTrigger = React.forwardRef<
...
MtTabsTrigger.displayName = TabsPrimitive.Trigger.displayName;

const MtTabsContent = TabsPrimitive.Content;

export { MtTabs, MtTabsContent, MtTabsList, MtTabsTrigger };
