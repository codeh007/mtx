...
const surveySubjects = async (
  ...
  const relatedSubjectsSchema = z.object({
    topics: z.array(z.string()).describe("Comprehensive list of related subjects as background research."),
  });
  const system=`I'm writing a Wikipedia page for a topic mentioned below. Please identify and recommend some Wikipedia pages on closely related subjects. I'm looking for examples that provide insights into interesting aspects commonly associated with this topic, or examples that help me understand the typical content and structure included in Wikipedia pages for similar topics.`
