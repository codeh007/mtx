...
export function Block({
  ...
  const handleVersionChange = (version: string) => {
    console.log("TODO: handleVersionChange", version);
  };
  const isDocumentsFetching = artQuery.isLoading;

  const getDocumentContentById = (id) => {
    console.log("TODO: getDocumentContentById", id);
    return "TODO: getDocumentContentById";
  };

  const saveContent = (a) => {
    console.log("TODO: saveContent", a);
  };
  const suggestions = [];
  const documents = [];
