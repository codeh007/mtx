...
import type { AddNodeProps } from "../FlowRenderer";
import type { WorkflowBlockNode } from "../nodes";
...
export function WorkflowNodeLibraryPanel({ onNodeClick, first }: Props) {
  ...
  return (
    <div className="w-[25rem] rounded-xl border border-slate-700  p-5 shadow-xl">
