...
export const controllerPartitionRelations = relations(
  controllerPartition,
  ({ many }) => ({
    tenants: many(tenant),
  }),
...
export const schedulerPartitionRelations = relations(
  schedulerPartition,
  ({ many }) => ({
    tenants: many(tenant),
  }),
...
export const tenantWorkerPartitionRelations = relations(
  tenantWorkerPartition,
  ({ many }) => ({
    tenants: many(tenant),
  }),
...
export const webhookWorkerRelations = relations(
  webhookWorker,
  ({ one, many }) => ({
    workers: many(worker),
    tenant: one(tenant, {
...
export const jobRunLookupDataRelations = relations(
  jobRunLookupData,
  ({ one }) => ({
    jobRun: one(jobRun, {
...
export const slackAppWebhookRelations = relations(
  slackAppWebhook,
  ({ one }) => ({
    tenant: one(tenant, {
...
export const socialMediaAgencyRelations = relations(
  socialMediaAgency,
  ({ one, many }) => ({
    media: one(media, {
...
export const stepDesiredWorkerLabelRelations = relations(
  stepDesiredWorkerLabel,
  ({ one }) => ({
    step: one(step, {
...
export const stepRunResultArchiveRelations = relations(
  stepRunResultArchive,
  ({ one }) => ({
    stepRun: one(stepRun, {
...
export const tenantAlertEmailGroupRelations = relations(
  tenantAlertEmailGroup,
  ({ one }) => ({
    tenant: one(tenant, {
...
export const tenantAlertingSettingsRelations = relations(
  tenantAlertingSettings,
  ({ one }) => ({
    tenant: one(tenant, {
...
export const tenantInviteLinkRelations = relations(
  tenantInviteLink,
  ({ one }) => ({
    tenant: one(tenant, {
...
export const tenantResourceLimitRelations = relations(
  tenantResourceLimit,
  ({ one, many }) => ({
    tenant: one(tenant, {
...
export const tenantResourceLimitAlertRelations = relations(
  tenantResourceLimitAlert,
  ({ one }) => ({
...
export const tenantVcsProviderRelations = relations(
  tenantVcsProvider,
  ({ one }) => ({
    tenant: one(tenant, {
...
export const webhookWorkerRequestRelations = relations(
  webhookWorkerRequest,
  ({ one }) => ({
    webhookWorker: one(webhookWorker, {
...
export const webhookWorkerWorkflowRelations = relations(
  webhookWorkerWorkflow,
  ({ one }) => ({
    webhookWorker: one(webhookWorker, {
...
export const workerAssignEventRelations = relations(
  workerAssignEvent,
  ({ one }) => ({
    worker: one(worker, {
...
export const workflowConcurrencyRelations = relations(
  workflowConcurrency,
  ({ one }) => ({
    action: one(action, {
...
export const workflowRunStickyStateRelations = relations(
  workflowRunStickyState,
  ({ one }) => ({
    workflowRun: one(workflowRun, {
...
export const workflowRunTriggeredByRelations = relations(
  workflowRunTriggeredBy,
  ({ one }) => ({
...
export const workflowTriggerEventRefRelations = relations(
  workflowTriggerEventRef,
  ({ one }) => ({
    workflowTrigger: one(workflowTriggers, {
...
export const serviceToWorkerRelations = relations(
  serviceToWorker,
  ({ one }) => ({
    service: one(service, {
...
export const workflowToWorkflowTagRelations = relations(
  workflowToWorkflowTag,
  ({ one }) => ({
    workflow: one(workflow, {
...
export const socialMediaAgencyNicheRelations = relations(
  socialMediaAgencyNiche,
  ({ one }) => ({
