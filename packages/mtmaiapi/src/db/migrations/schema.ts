...
export const concurrencyLimitStrategy = pgEnum("ConcurrencyLimitStrategy", [
  "CANCEL_IN_PROGRESS",
  "DROP_NEWEST",
  "QUEUE_NEWEST",
  "GROUP_ROUND_ROBIN",
...
export const internalQueue = pgEnum("InternalQueue", [
...
export const limitResource = pgEnum("LimitResource", [
  "WORKFLOW_RUN",
  "EVENT",
  "WORKER",
  "CRON",
...
export const workerLabelComparator = pgEnum("WorkerLabelComparator", [
  "EQUAL",
  "NOT_EQUAL",
  "GREATER_THAN",
...
export const popularPosts = pgTable(
  "PopularPosts",
  {
...
export const internalQueueItem = pgTable(
  "InternalQueueItem",
  {
  ...
  (table) => [
    index("InternalQueueItem_isQueued_tenantId_queue_priority_id_idx").using(
      "btree",
      table.isQueued.asc().nullsLast().op("enum_ops"),
      table.tenantId.asc().nullsLast().op("uuid_ops"),
      table.queue.asc().nullsLast().op("uuid_ops"),
      table.priority.desc().nullsFirst().op("uuid_ops"),
      table.id.asc().nullsLast().op("uuid_ops"),
    ),
    uniqueIndex("InternalQueueItem_tenantId_queue_uniqueKey_key").using(
      "btree",
...
export const chatSuggestion = pgTable(
  "ChatSuggestion",
  {
    id: uuid().primaryKey().notNull(),
    userId: uuid().notNull(),
    documentId: uuid().notNull(),
    documentCreatedAt: timestamp({ precision: 3, mode: "string" })
      .default(sql`CURRENT_TIMESTAMP`)
      .notNull(),
...
export const eventKey = pgTable(
  ...
  (table) => [
    uniqueIndex("EventKey_key_tenantId_key").using(
      "btree",
...
export const lease = pgTable(
  ...
  (table) => [
    uniqueIndex("Lease_tenantId_kind_resourceId_key").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
...
export const post = pgTable(
  ...
  (table) => [
    ...
    index("Post_parentPostId_idx").using(
      "btree",
      table.parentPostId.asc().nullsLast().op("uuid_ops"),
    ),
    index("Post_publishDate_idx").using(
      "btree",
...
export const queue = pgTable(
  ...
  (table) => [
    index("Queue_tenantId_lastActive_idx").using(
      "btree",
      table.tenantId.asc().nullsLast().op("timestamp_ops"),
      table.lastActive.asc().nullsLast().op("timestamp_ops"),
    ),
    uniqueIndex("Queue_tenantId_name_key").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
...
export const platformAccount = pgTable(
  ...
  (table) => [
    index("PlatformAccount_properties_gin_idx").using(
      "gin",
...
export const queueItem = pgTable(
  ...
  (table) => [
    index("QueueItem_isQueued_priority_tenantId_queue_id_idx_2").using(
      "btree",
      table.isQueued.asc().nullsLast().op("uuid_ops"),
      table.tenantId.asc().nullsLast().op("bool_ops"),
      table.queue.asc().nullsLast().op("bool_ops"),
      table.priority.desc().nullsFirst().op("bool_ops"),
      table.id.asc().nullsLast().op("uuid_ops"),
    ),
...
export const securityCheckIdent = pgTable(
  "SecurityCheckIdent",
  {
    id: uuid().primaryKey().notNull(),
  },
  (table) => [
    uniqueIndex("SecurityCheckIdent_id_key").using(
      "btree",
      table.id.asc().nullsLast().op("uuid_ops"),
    ),
  ],
...
export const semaphoreQueueItem = pgTable(
  "SemaphoreQueueItem",
  {
  ...
  (table) => [
    uniqueIndex("SemaphoreQueueItem_stepRunId_key").using(
      "btree",
      table.stepRunId.asc().nullsLast().op("uuid_ops"),
    ),
    index("SemaphoreQueueItem_tenantId_workerId_idx").using(
      "btree",
      table.tenantId.asc().nullsLast().op("uuid_ops"),
...
export const systemConfig = pgTable(
  ...
  (table) => [unique("SystemConfig_name_unique").on(table.name)],
);

export const stepRunEvent = pgTable(
  "StepRunEvent",
  {
    id: bigserial({ mode: "bigint" }).notNull(),
    timeFirstSeen: timestamp({ precision: 3, mode: "string" })
      .default(sql`CURRENT_TIMESTAMP`)
      .notNull(),
    timeLastSeen: timestamp({ precision: 3, mode: "string" })
      .default(sql`CURRENT_TIMESTAMP`)
      .notNull(),
    stepRunId: uuid(),
    workflowRunId: uuid(),
  ...
  (table) => [
    ...
    index("StepRunEvent_workflowRunId_idx").using(
      "btree",
...
export const timeoutQueueItem = pgTable(
  "TimeoutQueueItem",
  {
    id: bigserial({ mode: "bigint" }).primaryKey().notNull(),
  ...
  (table) => [
    uniqueIndex("TimeoutQueueItem_stepRunId_retryCount_key").using(
      "btree",
      table.stepRunId.asc().nullsLast().op("int4_ops"),
      table.retryCount.asc().nullsLast().op("int4_ops"),
    ),
    index("TimeoutQueueItem_tenantId_isQueued_timeoutAt_idx").using(
      "btree",
      table.tenantId.asc().nullsLast().op("timestamp_ops"),
      table.isQueued.asc().nullsLast().op("timestamp_ops"),
      table.timeoutAt.asc().nullsLast().op("timestamp_ops"),
    ),
  ],
);
...
export const vote = pgTable(
  ...
  (table) => [
    uniqueIndex("Vote_chatId_messageId_key").using(
      "btree",
...
export const workflowRun = pgTable(
  ...
  (table) => [
    index("WorkflowRun_byUserId_idx").using(
      "btree",
      table.byUserId.asc().nullsLast().op("uuid_ops"),
    ),
    index("WorkflowRun_createdAt_idx").using(
      "btree",
      table.createdAt.asc().nullsLast().op("timestamp_ops"),
    ),
    index("WorkflowRun_deletedAt_idx").using(
      "btree",
      table.deletedAt.asc().nullsLast().op("timestamp_ops"),
    ),
    index("WorkflowRun_finishedAt_idx").using(
      "btree",
    ...
    index("WorkflowRun_parentId_parentStepRunId_childIndex_key")
      .using(
        ...
        table.parentStepRunId.asc().nullsLast().op("int4_ops"),
        table.childIndex.asc().nullsLast().op("uuid_ops"),
      )
      .where(sql`("deletedAt" IS NULL)`),
    uniqueIndex("WorkflowRun_parentId_parentStepRunId_childKey_key").using(
      "btree",
      table.parentId.asc().nullsLast().op("text_ops"),
      table.parentStepRunId.asc().nullsLast().op("uuid_ops"),
      table.childKey.asc().nullsLast().op("uuid_ops"),
    ),
    index("WorkflowRun_parentStepRunId").using(
      "btree",
      table.parentStepRunId.asc().nullsLast().op("uuid_ops"),
    ),
    ...
    index("WorkflowRun_tenantId_idx").using(
      "btree",
      table.tenantId.asc().nullsLast().op("uuid_ops"),
    ),
    index("WorkflowRun_workflowVersionId_idx").using(
      "btree",
      table.workflowVersionId.asc().nullsLast().op("uuid_ops"),
    ),
    index("idx_workflowrun_concurrency").using(
      "btree",
      table.concurrencyGroupId.asc().nullsLast().op("text_ops"),
      table.createdAt.asc().nullsLast().op("text_ops"),
    ),
    index("idx_workflowrun_main").using(
      "btree",
      table.tenantId.asc().nullsLast().op("timestamp_ops"),
      table.deletedAt.asc().nullsLast().op("timestamp_ops"),
      table.status.asc().nullsLast().op("timestamp_ops"),
      table.workflowVersionId.asc().nullsLast().op("timestamp_ops"),
      table.createdAt.asc().nullsLast().op("timestamp_ops"),
    ),
    foreignKey({
...
export const workflowRunDedupe = pgTable(
  "WorkflowRunDedupe",
  {
    id: bigserial({ mode: "bigint" }).notNull(),
    createdAt: timestamp({ precision: 3, mode: "string" })
  ...
  (table) => [
    uniqueIndex("WorkflowRunDedupe_id_key").using(
      "btree",
      table.id.asc().nullsLast().op("int8_ops"),
    ),
    index("WorkflowRunDedupe_tenantId_value_idx").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
      table.value.asc().nullsLast().op("text_ops"),
    ),
    uniqueIndex("WorkflowRunDedupe_tenantId_workflowId_value_key").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
...
export const tenant = pgTable(
  ...
  (table) => [
    index("Tenant_controllerPartitionId_idx").using(
      "btree",
...
export const agentNode = pgTable(
  "AgentNode",
  {
    id: uuid().primaryKey().notNull(),
    createdAt: timestamp({ precision: 3, mode: "string" })
...
export const blogConfig = pgTable(
  "BlogConfig",
  {
    id: uuid().primaryKey().notNull(),
    blogId: uuid().notNull(),
  ...
  (table) => [
    uniqueIndex("BlogConfig_blogId_key").using(
      "btree",
...
export const getGroupKeyRun = pgTable(
  "GetGroupKeyRun",
  {
    id: uuid().primaryKey().notNull(),
    createdAt: timestamp({ precision: 3, mode: "string" })
  ...
  (table) => [
    index("GetGroupKeyRun_createdAt_idx").using(
      "btree",
      table.createdAt.asc().nullsLast().op("timestamp_ops"),
    ),
    index("GetGroupKeyRun_deletedAt_idx").using(
      "btree",
      table.deletedAt.asc().nullsLast().op("timestamp_ops"),
    ),
    ...
    index("GetGroupKeyRun_tenantId_deletedAt_status_idx").using(
      "btree",
      table.tenantId.asc().nullsLast().op("uuid_ops"),
      table.deletedAt.asc().nullsLast().op("timestamp_ops"),
      table.status.asc().nullsLast().op("timestamp_ops"),
    ),
    index("GetGroupKeyRun_tenantId_idx").using(
      "btree",
      table.tenantId.asc().nullsLast().op("uuid_ops"),
    ),
    index("GetGroupKeyRun_workerId_idx").using(
      "btree",
      table.workerId.asc().nullsLast().op("uuid_ops"),
    ),
    uniqueIndex("GetGroupKeyRun_workflowRunId_key").using(
      "btree",
      table.workflowRunId.asc().nullsLast().op("uuid_ops"),
    ),
    foreignKey({
...
export const integration = pgTable(
  ...
  (table) => [
    index("Integration_deletedAt_idx").using(
      "btree",
      table.deletedAt.asc().nullsLast().op("timestamp_ops"),
    ),
    ...
    uniqueIndex("Integration_organizationId_internalId_key").using(
      ...
      table.internalId.asc().nullsLast().op("uuid_ops"),
    ),
    index("Integration_updatedAt_idx").using(
      "btree",
      table.updatedAt.asc().nullsLast().op("timestamp_ops"),
    ),
    foreignKey({
...
export const workflowVersion = pgTable(
  ...
  (table) => [
    index("WorkflowVersion_deletedAt_idx").using(
      "btree",
      table.deletedAt.asc().nullsLast().op("timestamp_ops"),
    ),
    ...
    index("idx_workflow_version_workflow_id_order")
      .using(
        "btree",
        table.workflowId.asc().nullsLast().op("int8_ops"),
        table.order.desc().nullsFirst().op("int8_ops"),
      )
      .where(sql`("deletedAt" IS NULL)`),
    foreignKey({
...
export const jobRun = pgTable(
  ...
  (table) => [
    index("JobRun_deletedAt_idx").using(
      "btree",
      table.deletedAt.asc().nullsLast().op("timestamp_ops"),
    ),
...
export const jobRunLookupData = pgTable(
  "JobRunLookupData",
  {
    id: uuid().primaryKey().notNull(),
    createdAt: timestamp({ precision: 3, mode: "string" })
  ...
  (table) => [
    uniqueIndex("JobRunLookupData_id_key").using(
      "btree",
      table.id.asc().nullsLast().op("uuid_ops"),
    ),
    uniqueIndex("JobRunLookupData_jobRunId_key").using(
      "btree",
      table.jobRunId.asc().nullsLast().op("uuid_ops"),
    ),
    uniqueIndex("JobRunLookupData_jobRunId_tenantId_key").using(
      "btree",
      table.jobRunId.asc().nullsLast().op("uuid_ops"),
      table.tenantId.asc().nullsLast().op("uuid_ops"),
    ),
...
export const stepRun = pgTable(
  ...
  (table) => [
    index("StepRun_createdAt_idx").using(
      "btree",
      table.createdAt.asc().nullsLast().op("timestamp_ops"),
    ),
    index("StepRun_deletedAt_idx").using(
      "btree",
      table.deletedAt.asc().nullsLast().op("timestamp_ops"),
    ),
    ...
    index("StepRun_jobRunId_status_idx").using(
      "btree",
      table.jobRunId.asc().nullsLast().op("enum_ops"),
      table.status.asc().nullsLast().op("uuid_ops"),
    ),
    index("StepRun_jobRunId_status_tenantId_idx")
      .using(
        "btree",
        table.jobRunId.asc().nullsLast().op("enum_ops"),
        table.status.asc().nullsLast().op("enum_ops"),
      ...
      .where(sql`(status = 'PENDING'::"StepRunStatus")`),
    index("StepRun_jobRunId_tenantId_order_idx").using(
      "btree",
      table.jobRunId.asc().nullsLast().op("uuid_ops"),
...
export const messagesGroup = pgTable(
  "MessagesGroup",
  {
    id: uuid().primaryKey().notNull(),
    createdAt: timestamp({ precision: 3, mode: "string" })
  ...
  (table) => [
    index("MessagesGroup_createdAt_idx").using(
      "btree",
      table.createdAt.asc().nullsLast().op("timestamp_ops"),
    ),
...
export const messages = pgTable(
  ...
  (table) => [
    ...
    index("Messages_deletedAt_idx").using(
      "btree",
      table.deletedAt.asc().nullsLast().op("timestamp_ops"),
    ),
...
export const snsIntegration = pgTable(
  "SNSIntegration",
  {
    id: uuid().primaryKey().notNull(),
    createdAt: timestamp({ precision: 3, mode: "string" })
  ...
  (table) => [
    ...
    uniqueIndex("SNSIntegration_tenantId_topicArn_key").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
      table.topicArn.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
      columns: [table.tenantId],
      foreignColumns: [tenant.id],
...
export const slackAppWebhook = pgTable(
  "SlackAppWebhook",
  {
    id: uuid().primaryKey().notNull(),
    createdAt: timestamp({ precision: 3, mode: "string" })
...
export const socialMediaAgency = pgTable(
  "SocialMediaAgency",
  {
    id: uuid().primaryKey().notNull(),
    userId: uuid().notNull(),
  ...
  (table) => [
    index("SocialMediaAgency_deletedAt_idx").using(
      "btree",
      table.deletedAt.asc().nullsLast().op("timestamp_ops"),
    ),
    ...
    index("SocialMediaAgency_userId_idx").using(
      "btree",
...
export const step = pgTable(
  ...
  (table) => [
    ...
    uniqueIndex("Step_jobId_readableId_key").using(
      ...
      table.readableId.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
...
export const stepDesiredWorkerLabel = pgTable(
  ...
  (table) => [
    index("StepDesiredWorkerLabel_stepId_idx").using(
      "btree",
      table.stepId.asc().nullsLast().op("uuid_ops"),
    ),
    uniqueIndex("StepDesiredWorkerLabel_stepId_key_key").using(
      "btree",
...
export const stepRateLimit = pgTable(
  ...
  (table) => [
    uniqueIndex("StepRateLimit_stepId_rateLimitKey_key").using(
      "btree",
      table.stepId.asc().nullsLast().op("text_ops"),
      table.rateLimitKey.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
...
export const stepRunResultArchive = pgTable(
  ...
  (table) => [
    uniqueIndex("StepRunResultArchive_id_key").using(
      "btree",
      table.id.asc().nullsLast().op("uuid_ops"),
    ),
    foreignKey({
...
export const controllerPartition = pgTable(
  "ControllerPartition",
  {
  ...
  (table) => [
    uniqueIndex("ControllerPartition_id_key").using(
      "btree",
...
export const schedulerPartition = pgTable(
  "SchedulerPartition",
  {
    id: text().primaryKey().notNull(),
    createdAt: timestamp({ precision: 3, mode: "string" })
  ...
  (table) => [
    uniqueIndex("SchedulerPartition_id_key").using(
      "btree",
      table.id.asc().nullsLast().op("text_ops"),
    ),
  ],
...
export const tenantWorkerPartition = pgTable(
  ...
  (table) => [
    uniqueIndex("TenantWorkerPartition_id_key").using(
      "btree",
      table.id.asc().nullsLast().op("text_ops"),
    ),
  ],
...
export const tenantAlertEmailGroup = pgTable(
  ...
  (table) => [
    uniqueIndex("TenantAlertEmailGroup_id_key").using(
      "btree",
      table.id.asc().nullsLast().op("uuid_ops"),
    ),
    foreignKey({
...
export const tenantAlertingSettings = pgTable(
  ...
  (table) => [
    uniqueIndex("TenantAlertingSettings_id_key").using(
      "btree",
      table.id.asc().nullsLast().op("uuid_ops"),
    ),
    uniqueIndex("TenantAlertingSettings_tenantId_key").using(
      "btree",
      table.tenantId.asc().nullsLast().op("uuid_ops"),
    ),
    foreignKey({
...
export const tenantInviteLink = pgTable(
  "TenantInviteLink",
  {
    id: uuid().primaryKey().notNull(),
    createdAt: timestamp({ precision: 3, mode: "string" })
  ...
  (table) => [
    uniqueIndex("TenantInviteLink_id_key").using(
      "btree",
      table.id.asc().nullsLast().op("uuid_ops"),
    ),
    foreignKey({
...
export const tenantResourceLimit = pgTable(
  "TenantResourceLimit",
  {
    id: uuid().primaryKey().notNull(),
    createdAt: timestamp({ precision: 3, mode: "string" })
  ...
  (table) => [
    uniqueIndex("TenantResourceLimit_id_key").using(
      "btree",
      table.id.asc().nullsLast().op("uuid_ops"),
    ),
    uniqueIndex("TenantResourceLimit_tenantId_resource_key").using(
      "btree",
      table.tenantId.asc().nullsLast().op("uuid_ops"),
      table.resource.asc().nullsLast().op("uuid_ops"),
    ),
    foreignKey({
      columns: [table.tenantId],
      foreignColumns: [tenant.id],
...
export const tenantResourceLimitAlert = pgTable(
  ...
  (table) => [
    uniqueIndex("TenantResourceLimitAlert_id_key").using(
      "btree",
      table.id.asc().nullsLast().op("uuid_ops"),
    ),
    foreignKey({
...
export const tenantVcsProvider = pgTable(
  "TenantVcsProvider",
  {
    id: uuid().primaryKey().notNull(),
    createdAt: timestamp({ precision: 3, mode: "string" })
  ...
  (table) => [
    uniqueIndex("TenantVcsProvider_id_key").using(
      "btree",
      table.id.asc().nullsLast().op("uuid_ops"),
    ),
    uniqueIndex("TenantVcsProvider_tenantId_vcsProvider_key").using(
      "btree",
      table.tenantId.asc().nullsLast().op("uuid_ops"),
      table.vcsProvider.asc().nullsLast().op("uuid_ops"),
    ),
    foreignKey({
      columns: [table.tenantId],
      foreignColumns: [tenant.id],
...
export const userOauth = pgTable(
  ...
  (table) => [
    ...
    uniqueIndex("UserOAuth_userId_provider_key").using(
      "btree",
...
export const userPassword = pgTable(
  ...
  (table) => [
    uniqueIndex("UserPassword_userId_key").using(
      "btree",
      table.userId.asc().nullsLast().op("uuid_ops"),
    ),
    foreignKey({
...
export const webhookWorker = pgTable(
  "WebhookWorker",
  {
    id: uuid().primaryKey().notNull(),
    createdAt: timestamp({ precision: 3, mode: "string" })
...
export const webhookWorkerRequest = pgTable(
  ...
  (table) => [
    uniqueIndex("WebhookWorkerRequest_id_key").using(
      "btree",
      table.id.asc().nullsLast().op("uuid_ops"),
    ),
    foreignKey({
...
export const webhookWorkerWorkflow = pgTable(
  ...
  (table) => [
    uniqueIndex("WebhookWorkerWorkflow_id_key").using(
      "btree",
      table.id.asc().nullsLast().op("uuid_ops"),
    ),
    uniqueIndex("WebhookWorkerWorkflow_webhookWorkerId_workflowId_key").using(
      "btree",
      table.webhookWorkerId.asc().nullsLast().op("uuid_ops"),
      table.workflowId.asc().nullsLast().op("uuid_ops"),
    ),
    foreignKey({
      columns: [table.webhookWorkerId],
      foreignColumns: [webhookWorker.id],
...
export const workflow = pgTable(
  ...
  (table) => [
    index("Workflow_deletedAt_idx").using(
      "btree",
      table.deletedAt.asc().nullsLast().op("timestamp_ops"),
    ),
...
export const workerAssignEvent = pgTable(
  "WorkerAssignEvent",
  {
    id: bigserial({ mode: "bigint" }).primaryKey().notNull(),
    workerId: uuid().notNull(),
  ...
  (table) => [
    index("WorkerAssignEvent_workerId_id_idx").using(
      "btree",
      table.workerId.asc().nullsLast().op("int8_ops"),
      table.id.asc().nullsLast().op("int8_ops"),
    ),
    foreignKey({
      columns: [table.workerId],
...
export const workerLabel = pgTable(
  "WorkerLabel",
  {
    id: bigserial({ mode: "bigint" }).primaryKey().notNull(),
    createdAt: timestamp({ precision: 3, mode: "string" })
  ...
  (table) => [
    index("WorkerLabel_workerId_idx").using(
      "btree",
      table.workerId.asc().nullsLast().op("uuid_ops"),
    ),
    uniqueIndex("WorkerLabel_workerId_key_key").using(
      "btree",
      table.workerId.asc().nullsLast().op("text_ops"),
      table.key.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
      columns: [table.workerId],
...
export const workflowConcurrency = pgTable(
  "WorkflowConcurrency",
  {
    id: uuid().primaryKey().notNull(),
    createdAt: timestamp({ precision: 3, mode: "string" })
  ...
  (table) => [
    ...
    uniqueIndex("WorkflowConcurrency_workflowVersionId_key").using(
      "btree",
      table.workflowVersionId.asc().nullsLast().op("uuid_ops"),
    ),
    foreignKey({
...
export const workflowRunStickyState = pgTable(
  ...
  (table) => [
    uniqueIndex("WorkflowRunStickyState_workflowRunId_key").using(
      "btree",
      table.workflowRunId.asc().nullsLast().op("uuid_ops"),
    ),
    foreignKey({
...
export const workflowTriggerCronRef = pgTable(
...
export const workflowRunTriggeredBy = pgTable(
  ...
  (table) => [
    index("WorkflowRunTriggeredBy_eventId_idx").using(
      "btree",
      table.eventId.asc().nullsLast().op("uuid_ops"),
    ),
    uniqueIndex("WorkflowRunTriggeredBy_id_key").using(
      "btree",
      table.id.asc().nullsLast().op("uuid_ops"),
    ),
    index("WorkflowRunTriggeredBy_parentId_idx").using(
      "btree",
      table.parentId.asc().nullsLast().op("uuid_ops"),
    ),
    uniqueIndex("WorkflowRunTriggeredBy_parentId_key").using(
      "btree",
      table.parentId.asc().nullsLast().op("uuid_ops"),
    ),
    uniqueIndex("WorkflowRunTriggeredBy_scheduledId_key").using(
      "btree",
      table.scheduledId.asc().nullsLast().op("uuid_ops"),
    ),
    index("WorkflowRunTriggeredBy_tenantId_idx").using(
      "btree",
      table.tenantId.asc().nullsLast().op("uuid_ops"),
    ),
    foreignKey({
...
export const workflowTriggerScheduledRef = pgTable(
  ...
  (table) => [
    uniqueIndex("WorkflowTriggerScheduledRef_id_key").using(
      "btree",
      table.id.asc().nullsLast().op("uuid_ops"),
    ),
...
export const workflowTag = pgTable(
  "WorkflowTag",
  {
    id: uuid().primaryKey().notNull(),
    createdAt: timestamp({ precision: 3, mode: "string" })
...
export const workflowTriggers = pgTable(
  ...
  (table) => [
    uniqueIndex("WorkflowTriggers_id_key").using(
      "btree",
      table.id.asc().nullsLast().op("uuid_ops"),
    ),
    uniqueIndex("WorkflowTriggers_workflowVersionId_key").using(
      "btree",
      table.workflowVersionId.asc().nullsLast().op("uuid_ops"),
    ),
    index("idx_workflow_triggers_workflow_version_id").using(
      "btree",
      table.workflowVersionId.asc().nullsLast().op("uuid_ops"),
    ),
    foreignKey({
...
export const workflowTriggerEventRef = pgTable(
  ...
  (table) => [
    uniqueIndex("WorkflowTriggerEventRef_parentId_eventKey_key").using(
      "btree",
      table.parentId.asc().nullsLast().op("text_ops"),
      table.eventKey.asc().nullsLast().op("text_ops"),
    ),
    index("idx_workflow_trigger_event_ref_event_key_parent_id").using(
      "btree",
      table.eventKey.asc().nullsLast().op("text_ops"),
      table.parentId.asc().nullsLast().op("text_ops"),
    ),
...
export const actionToWorker = pgTable(
  "_ActionToWorker",
  {
    a: uuid("A").notNull(),
    b: uuid("B").notNull(),
  ...
  (table) => [
    uniqueIndex("_ActionToWorker_AB_unique").using(
      "btree",
      table.a.asc().nullsLast().op("uuid_ops"),
      table.b.asc().nullsLast().op("uuid_ops"),
    ),
...
export const blogPostToTag = pgTable(
  "_BlogPostToTag",
  {
    a: uuid("A").notNull(),
    b: uuid("B").notNull(),
  ...
  (table) => [
    uniqueIndex("_BlogPostToTag_AB_unique").using(
      "btree",
      table.a.asc().nullsLast().op("uuid_ops"),
      table.b.asc().nullsLast().op("uuid_ops"),
    ),
...
export const mediaToUser = pgTable(
  ...
  (table) => [
    uniqueIndex("_MediaToUser_AB_unique").using(
      "btree",
      table.a.asc().nullsLast().op("uuid_ops"),
      table.b.asc().nullsLast().op("uuid_ops"),
    ),
...
export const serviceToWorker = pgTable(
  "_ServiceToWorker",
  {
    a: uuid("A").notNull(),
    b: uuid("B").notNull(),
  ...
  (table) => [
    uniqueIndex("_ServiceToWorker_AB_unique").using(
      "btree",
      table.a.asc().nullsLast().op("uuid_ops"),
      table.b.asc().nullsLast().op("uuid_ops"),
    ),
...
export const stepOrder = pgTable(
  "_StepOrder",
  {
    a: uuid("A").notNull(),
    b: uuid("B").notNull(),
  ...
  (table) => [
    uniqueIndex("_StepOrder_AB_unique").using(
      "btree",
      table.a.asc().nullsLast().op("uuid_ops"),
      table.b.asc().nullsLast().op("uuid_ops"),
    ),
...
export const stepRunOrder = pgTable(
  "_StepRunOrder",
  {
    a: uuid("A").notNull(),
    b: uuid("B").notNull(),
  ...
  (table) => [
    uniqueIndex("_StepRunOrder_AB_unique").using(
      "btree",
      table.a.asc().nullsLast().op("uuid_ops"),
      table.b.asc().nullsLast().op("uuid_ops"),
    ),
...
export const workflowToWorkflowTag = pgTable(
  "_WorkflowToWorkflowTag",
  {
    a: uuid("A").notNull(),
    b: uuid("B").notNull(),
  },
  (table) => [
    uniqueIndex("_WorkflowToWorkflowTag_AB_unique").using(
      "btree",
      table.a.asc().nullsLast().op("uuid_ops"),
      table.b.asc().nullsLast().op("uuid_ops"),
    ),
...
export const socialMediaAgencyNiche = pgTable(
  ...
  (table) => [
    foreignKey({
      ...
      .onDelete("restrict"),
    primaryKey({
      columns: [table.agencyId, table.niche],
      name: "SocialMediaAgencyNiche_pkey",
    }),
  ],
);

export const stepExpression = pgTable(
  "StepExpression",
  {
    key: text().notNull(),
    stepId: uuid().notNull(),
  ...
  (table) => [
    primaryKey({
      columns: [table.key, table.stepId, table.kind],
      name: "StepExpression_pkey",
    }),
  ],
);

export const stepRunExpressionEval = pgTable(
  ...
  (table) => [
    index("StepRunExpressionEval_stepRunId_idx").using(
      "btree",
      table.stepRunId.asc().nullsLast().op("uuid_ops"),
    ),
    primaryKey({
      columns: [table.key, table.stepRunId, table.kind],
...
export const kvStore = pgTable(
  ...
  (table) => [
    index("KVStore_ns_key_idx").using(
      "btree",
      table.ns.asc().nullsLast().op("text_ops"),
      table.key.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
      columns: [table.tenantId],
