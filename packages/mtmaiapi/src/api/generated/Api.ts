...
> extends HttpClient<SecurityDataType> {
  ...
  /**
   * @description Get the tasks for the tenant
   *
   * @tags Tenant
   * @name TenantGetTasks
   * @summary Get step run metrics
   * @request GET:/api/v1/tenants/{tenant}/tasks
   * @secure
   */
  tenantGetTasks = (tenant: string, params: RequestParams = {}) =>
    this.request<TaskList, any>({
      path: `/api/v1/tenants/${tenant}/tasks`,
      method: "GET",
      secure: true,
      format: "json",
      ...params,
  ...
  /**
   * @description MtBizflow 运行自定义任务
   *
   * @tags mtbizflow
   * @name MtbizflowList
   * @summary 测试124
   * @request GET:/api/v1/mtbizflow/callservice/{serviceName}
   * @secure
   */
  mtbizflowList = (serviceName: string, params: RequestParams = {}) =>
    this.request<MyItem, any>({
      path: `/api/v1/mtbizflow/callservice/${serviceName}`,
      method: "GET",
      secure: true,
      format: "json",
      ...params,
  ...
  /**
   * @description 启动 llm proxy 代理
   *
   * @tags llmproxy
   * @name LlmproxyStart
   * @summary 代理启动状态
   * @request GET:/api/v1/llm/start
   * @secure
   */
  llmproxyStart = (params: RequestParams = {}) =>
    this.request<LlmProxyStartResponse, any>({
      path: `/api/v1/llm/start`,
      method: "GET",
      secure: true,
      format: "json",
      ...params,
   ...
   * @secure
   */
  chatChat = (data: ChatReq, params: RequestParams = {}) =>
   ...
   * @name ChatMessages
   * @summary 获取聊天消息
   * @request GET:/api/v1/chat/{chatId}/messages
   * @secure
   */
  chatMessages = (chatId: string, params: RequestParams = {}) =>
   ...
   * @secure
   */
  chatModels = (params: RequestParams = {}) =>
    this.request<ChatModels, any>({
      path: `/api/v1/models`,
      method: "GET",
      secure: true,
      format: "json",
   ...
   * @secure
   */
  chatCompletions = (data: ChatCompletionsReq, params: RequestParams = {}) =>
   ...
   * @name ChatHistory
   * @summary 获取聊天历史
   * @request GET:/api/v1/chat/history
   * @secure
   */
  chatHistory = (params: RequestParams = {}) =>
    this.request<ChatHistory, any>({
