...
export function groupKeyActionEventTypeFromJSON(
  object: any,
...
export function groupKeyActionEventTypeToJSON(
  object: GroupKeyActionEventType,
): string {
  switch (object) {
...
export function workflowRunEventTypeFromJSON(
  object: any,
...
export function workflowRunEventTypeToJSON(
...
export const WorkerRegisterRequest: MessageFns<WorkerRegisterRequest> = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          ...
          const entry5 = WorkerRegisterRequest_LabelsEntry.decode(
            reader,
            reader.uint32(),
          );
  ...
  fromPartial(
    object: DeepPartial<WorkerRegisterRequest>,
  ): WorkerRegisterRequest {
    const message = createBaseWorkerRegisterRequest();
...
export const WorkerRegisterRequest_LabelsEntry: MessageFns<WorkerRegisterRequest_LabelsEntry> =
  {
    ...
    fromJSON(object: any): WorkerRegisterRequest_LabelsEntry {
      return {
        ...
        value: isSet(object.value)
          ? WorkerLabels.fromJSON(object.value)
          : undefined,
      };
    },
    ...
    create(
      base?: DeepPartial<WorkerRegisterRequest_LabelsEntry>,
    ): WorkerRegisterRequest_LabelsEntry {
...
export const WorkerRegisterResponse: MessageFns<WorkerRegisterResponse> = {
  ...
  fromPartial(
    object: DeepPartial<WorkerRegisterResponse>,
  ): WorkerRegisterResponse {
    const message = createBaseWorkerRegisterResponse();
...
export const UpsertWorkerLabelsRequest: MessageFns<UpsertWorkerLabelsRequest> =
  {
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 2:
            ...
            const entry2 = UpsertWorkerLabelsRequest_LabelsEntry.decode(
              reader,
              reader.uint32(),
            );
    ...
    fromJSON(object: any): UpsertWorkerLabelsRequest {
      return {
        workerId: isSet(object.workerId)
          ...
          : "",
        labels: isObject(object.labels)
          ? Object.entries(object.labels).reduce<{
              [key: string]: WorkerLabels;
            }>((acc, [key, value]) => {
              acc[key] = WorkerLabels.fromJSON(value);
              return acc;
    ...
    create(
      base?: DeepPartial<UpsertWorkerLabelsRequest>,
    ): UpsertWorkerLabelsRequest {
      return UpsertWorkerLabelsRequest.fromPartial(base ?? {});
    },
    fromPartial(
      object: DeepPartial<UpsertWorkerLabelsRequest>,
    ): UpsertWorkerLabelsRequest {
      const message = createBaseUpsertWorkerLabelsRequest();
      message.workerId = object.workerId ?? "";
      message.labels = Object.entries(object.labels ?? {}).reduce<{
...
export const UpsertWorkerLabelsResponse: MessageFns<UpsertWorkerLabelsResponse> =
  {
    ...
    create(
      base?: DeepPartial<UpsertWorkerLabelsResponse>,
    ): UpsertWorkerLabelsResponse {
      return UpsertWorkerLabelsResponse.fromPartial(base ?? {});
    },
    fromPartial(
      object: DeepPartial<UpsertWorkerLabelsResponse>,
    ): UpsertWorkerLabelsResponse {
      const message = createBaseUpsertWorkerLabelsResponse();
      message.tenantId = object.tenantId ?? "";
      message.workerId = object.workerId ?? "";
...
export const AssignedAction: MessageFns<AssignedAction> = {
  ...
  fromJSON(object: any): AssignedAction {
    return {
      ...
      stepRunId: isSet(object.stepRunId)
        ? globalThis.String(object.stepRunId)
        : "",
...
export const WorkerUnsubscribeRequest: MessageFns<WorkerUnsubscribeRequest> = {
  ...
  create(
    base?: DeepPartial<WorkerUnsubscribeRequest>,
  ): WorkerUnsubscribeRequest {
    return WorkerUnsubscribeRequest.fromPartial(base ?? {});
  },
  fromPartial(
    object: DeepPartial<WorkerUnsubscribeRequest>,
  ): WorkerUnsubscribeRequest {
    const message = createBaseWorkerUnsubscribeRequest();
    message.workerId = object.workerId ?? "";
    return message;
...
export const WorkerUnsubscribeResponse: MessageFns<WorkerUnsubscribeResponse> =
  {
    ...
    create(
      base?: DeepPartial<WorkerUnsubscribeResponse>,
    ): WorkerUnsubscribeResponse {
      return WorkerUnsubscribeResponse.fromPartial(base ?? {});
    },
    fromPartial(
      object: DeepPartial<WorkerUnsubscribeResponse>,
    ): WorkerUnsubscribeResponse {
      const message = createBaseWorkerUnsubscribeResponse();
      message.tenantId = object.tenantId ?? "";
      message.workerId = object.workerId ?? "";
...
export const GroupKeyActionEvent: MessageFns<GroupKeyActionEvent> = {
  encode(
    ...
    if (message.eventTimestamp !== undefined) {
      Timestamp.encode(
        toTimestamp(message.eventTimestamp),
        writer.uint32(42).fork(),
      ).join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          ...
          message.eventTimestamp = fromTimestamp(
...
function createBaseSubscribeToWorkflowEventsRequest(): SubscribeToWorkflowEventsRequest {
  return {
    ...
    additionalMetaKey: undefined,
    additionalMetaValue: undefined,
  };
}
...
export const SubscribeToWorkflowEventsRequest: MessageFns<SubscribeToWorkflowEventsRequest> =
  {
    ...
    create(
      base?: DeepPartial<SubscribeToWorkflowEventsRequest>,
    ): SubscribeToWorkflowEventsRequest {
...
export const SubscribeToWorkflowRunsRequest: MessageFns<SubscribeToWorkflowRunsRequest> =
  {
    ...
    create(
      base?: DeepPartial<SubscribeToWorkflowRunsRequest>,
    ): SubscribeToWorkflowRunsRequest {
      return SubscribeToWorkflowRunsRequest.fromPartial(base ?? {});
    },
    fromPartial(
      object: DeepPartial<SubscribeToWorkflowRunsRequest>,
    ): SubscribeToWorkflowRunsRequest {
      const message = createBaseSubscribeToWorkflowRunsRequest();
      message.workflowRunId = object.workflowRunId ?? "";
      return message;
...
export const WorkflowEvent: MessageFns<WorkflowEvent> = {
  ...
  fromJSON(object: any): WorkflowEvent {
    return {
      ...
      stepRetries: isSet(object.stepRetries)
        ? globalThis.Number(object.stepRetries)
        : undefined,
      retryCount: isSet(object.retryCount)
        ? globalThis.Number(object.retryCount)
        : undefined,
...
export const WorkflowRunEvent: MessageFns<WorkflowRunEvent> = {
  ...
  fromPartial(object: DeepPartial<WorkflowRunEvent>): WorkflowRunEvent {
    ...
    message.eventTimestamp = object.eventTimestamp ?? undefined;
    message.results =
      object.results?.map((e) => StepRunResult.fromPartial(e)) || [];
    return message;
  },
};
  ...
  fromJSON(object: any): StepRunResult {
    return {
      stepRunId: isSet(object.stepRunId)
        ? globalThis.String(object.stepRunId)
        : "",
      stepReadableId: isSet(object.stepReadableId)
        ? globalThis.String(object.stepReadableId)
        : "",
      jobRunId: isSet(object.jobRunId)
        ? globalThis.String(object.jobRunId)
        : "",
      ...
      output: isSet(object.output)
        ? globalThis.String(object.output)
        : undefined,
    };
  },
...
export const HeartbeatRequest: MessageFns<HeartbeatRequest> = {
  encode(
    ...
    if (message.heartbeatAt !== undefined) {
      Timestamp.encode(
        toTimestamp(message.heartbeatAt),
        writer.uint32(18).fork(),
      ).join();
    }
    return writer;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          message.heartbeatAt = fromTimestamp(
            Timestamp.decode(reader, reader.uint32()),
          );
          continue;
      }
...
export const RefreshTimeoutRequest: MessageFns<RefreshTimeoutRequest> = {
  ...
  fromPartial(
    object: DeepPartial<RefreshTimeoutRequest>,
  ): RefreshTimeoutRequest {
    const message = createBaseRefreshTimeoutRequest();
    message.stepRunId = object.stepRunId ?? "";
...
export const RefreshTimeoutResponse: MessageFns<RefreshTimeoutResponse> = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.timeoutAt = fromTimestamp(
            Timestamp.decode(reader, reader.uint32()),
          );
          continue;
      }
  ...
  fromPartial(
    object: DeepPartial<RefreshTimeoutResponse>,
  ): RefreshTimeoutResponse {
    const message = createBaseRefreshTimeoutResponse();
