...
export class Api<SecurityDataType = unknown> extends HttpClient<SecurityDataType> {
   ...
   * @secure
   */
  teamList = (tenant: TenantParameter, params: RequestParams = {}) =>
   ...
   * @secure
   */
  teamCreate = (tenant: TenantParameter, data: TeamCreate, params: RequestParams = {}) =>
   ...
   * @secure
   */
  teamUpsert = (tenant: TenantParameter, team: string, data: Team, params: RequestParams = {}) =>
    this.request<Team, APIErrors>({
      path: `/api/v1/tenants/${tenant}/teams/${team}`,
      method: "PATCH",
      body: data,
   ...
   * @secure
   */
  agStateGet = (tenant: TenantParameter, state: string, params: RequestParams = {}) =>
   ...
   * @secure
   */
  agStateUpsert = (tenant: TenantParameter, state: string, data: AgStateUpsert, params: RequestParams = {}) =>
    this.request<AgState, APIErrors>({
      path: `/api/v1/tenants/${tenant}/agStates/${state}`,
      method: "PATCH",
      body: data,
   ...
   * @secure
   */
  tenantSeed = (tenant: string, data: TenantSeedReq, params: RequestParams = {}) =>
    this.request<CommonResult, APIErrors>({
   ...
   * @secure
   */
  chatCreateMessage = (tenant: TenantParameter, data: ChatMessageCreate, params: RequestParams = {}) =>
   ...
   * @secure
   */
  chatSessionCreate = (tenant: TenantParameter, data: ChatSessionUpdate, params: RequestParams = {}) =>
   ...
   * @secure
   */
  chatSessionGet = (tenant: TenantParameter, session: string, params: RequestParams = {}) =>
    this.request<ChatSession, APIErrors | APIError>({
   ...
   * @secure
   */
  chatSessionUpdate = (tenant: TenantParameter, session: string, data: ChatSessionUpdate, params: RequestParams = {}) =>
    this.request<ChatSession, APIErrors | APIError>({
      path: `/api/v1/tenants/${tenant}/chat/sessions/${session}`,
      method: "PUT",
      body: data,
