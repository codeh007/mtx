...
export function concurrencyLimitStrategyFromJSON(
  object: any,
...
export function concurrencyLimitStrategyToJSON(
  object: ConcurrencyLimitStrategy,
): string {
  switch (object) {
...
export function workerLabelComparatorFromJSON(
  object: any,
...
export function workerLabelComparatorToJSON(
  object: WorkerLabelComparator,
): string {
  switch (object) {
...
export const PutWorkflowRequest: MessageFns<PutWorkflowRequest> = {
  encode(
    ...
    if (message.opts !== undefined) {
      CreateWorkflowVersionOpts.encode(
        message.opts,
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.opts = CreateWorkflowVersionOpts.decode(
            reader,
            reader.uint32(),
          );
          continue;
  ...
  fromJSON(object: any): PutWorkflowRequest {
    return {
      opts: isSet(object.opts)
        ? CreateWorkflowVersionOpts.fromJSON(object.opts)
        : undefined,
    };
  },
...
export const CreateWorkflowVersionOpts: MessageFns<CreateWorkflowVersionOpts> =
  {
    encode(
      ...
      if (message.concurrency !== undefined) {
        WorkflowConcurrencyOpts.encode(
          message.concurrency,
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 6:
            ...
            message.scheduledTriggers.push(
          ...
          case 7:
            ...
            message.jobs.push(
              CreateWorkflowJobOpts.decode(reader, reader.uint32()),
            );
            continue;
          case 8:
            if (tag !== 66) {
            ...
            message.concurrency = WorkflowConcurrencyOpts.decode(
              reader,
              reader.uint32(),
            );
            continue;
          ...
          case 11:
            ...
            message.onFailureJob = CreateWorkflowJobOpts.decode(
              reader,
              reader.uint32(),
            );
            continue;
    ...
    fromJSON(object: any): CreateWorkflowVersionOpts {
      return {
        ...
        onFailureJob: isSet(object.onFailureJob)
          ...
          : undefined,
        sticky: isSet(object.sticky)
          ? stickyStrategyFromJSON(object.sticky)
          : undefined,
        kind: isSet(object.kind)
          ? workflowKindFromJSON(object.kind)
          : undefined,
    ...
    toJSON(message: CreateWorkflowVersionOpts): unknown {
      ...
      if (message.scheduledTriggers?.length) {
        obj.scheduledTriggers = message.scheduledTriggers.map((e) =>
          e.toISOString(),
        );
      }
    ...
    create(
      base?: DeepPartial<CreateWorkflowVersionOpts>,
    ): CreateWorkflowVersionOpts {
      return CreateWorkflowVersionOpts.fromPartial(base ?? {});
    },
    fromPartial(
      object: DeepPartial<CreateWorkflowVersionOpts>,
    ): CreateWorkflowVersionOpts {
      const message = createBaseCreateWorkflowVersionOpts();
      ...
      message.jobs =
        object.jobs?.map((e) => CreateWorkflowJobOpts.fromPartial(e)) || [];
      message.concurrency =
...
export const WorkflowConcurrencyOpts: MessageFns<WorkflowConcurrencyOpts> = {
  ...
  fromPartial(
    object: DeepPartial<WorkflowConcurrencyOpts>,
  ): WorkflowConcurrencyOpts {
    const message = createBaseWorkflowConcurrencyOpts();
...
export const CreateWorkflowJobOpts: MessageFns<CreateWorkflowJobOpts> = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          message.steps.push(
            CreateWorkflowStepOpts.decode(reader, reader.uint32()),
          );
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromPartial(
    object: DeepPartial<CreateWorkflowJobOpts>,
  ): CreateWorkflowJobOpts {
    const message = createBaseCreateWorkflowJobOpts();
    message.name = object.name ?? "";
    message.description = object.description ?? "";
    message.steps =
      object.steps?.map((e) => CreateWorkflowStepOpts.fromPartial(e)) || [];
    return message;
  },
};
...
export const CreateWorkflowStepOpts: MessageFns<CreateWorkflowStepOpts> = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 8:
          ...
          message.rateLimits.push(
            CreateStepRateLimit.decode(reader, reader.uint32()),
          );
          continue;
        case 9:
          if (tag !== 74) {
          ...
          const entry9 = CreateWorkflowStepOpts_WorkerLabelsEntry.decode(
            reader,
            reader.uint32(),
          );
  ...
  fromJSON(object: any): CreateWorkflowStepOpts {
    return {
      ...
      workerLabels: isObject(object.workerLabels)
        ? Object.entries(object.workerLabels).reduce<{
  ...
  fromPartial(
    object: DeepPartial<CreateWorkflowStepOpts>,
  ): CreateWorkflowStepOpts {
    const message = createBaseCreateWorkflowStepOpts();
    ...
    message.rateLimits =
      object.rateLimits?.map((e) => CreateStepRateLimit.fromPartial(e)) || [];
    ...
    fromJSON(object: any): CreateWorkflowStepOpts_WorkerLabelsEntry {
      return {
        ...
        value: isSet(object.value)
          ? DesiredWorkerLabels.fromJSON(object.value)
          : undefined,
      };
    },
  ...
  fromJSON(object: any): CreateStepRateLimit {
    return {
      ...
      duration: isSet(object.duration)
        ? rateLimitDurationFromJSON(object.duration)
        : undefined,
    };
  },
...
export const ScheduleWorkflowRequest: MessageFns<ScheduleWorkflowRequest> = {
  ...
  fromPartial(
    object: DeepPartial<ScheduleWorkflowRequest>,
  ): ScheduleWorkflowRequest {
    const message = createBaseScheduleWorkflowRequest();
    message.name = object.name ?? "";
...
export const WorkflowTriggerEventRef: MessageFns<WorkflowTriggerEventRef> = {
  ...
  fromPartial(
    object: DeepPartial<WorkflowTriggerEventRef>,
  ): WorkflowTriggerEventRef {
    const message = createBaseWorkflowTriggerEventRef();
...
export const WorkflowTriggerCronRef: MessageFns<WorkflowTriggerCronRef> = {
  ...
  fromPartial(
    object: DeepPartial<WorkflowTriggerCronRef>,
  ): WorkflowTriggerCronRef {
    const message = createBaseWorkflowTriggerCronRef();
    message.parentId = object.parentId ?? "";
...
export const BulkTriggerWorkflowRequest: MessageFns<BulkTriggerWorkflowRequest> =
  {
        ...
        switch (tag >>> 3) {
          case 1:
            ...
            message.workflows.push(
              TriggerWorkflowRequest.decode(reader, reader.uint32()),
            );
            continue;
        }
        if ((tag & 7) === 4 || tag === 0) {
    ...
    toJSON(message: BulkTriggerWorkflowRequest): unknown {
      ...
      if (message.workflows?.length) {
        obj.workflows = message.workflows.map((e) =>
          TriggerWorkflowRequest.toJSON(e),
        );
      }
      return obj;
    },
    ...
    create(
      base?: DeepPartial<BulkTriggerWorkflowRequest>,
    ): BulkTriggerWorkflowRequest {
      return BulkTriggerWorkflowRequest.fromPartial(base ?? {});
    },
    fromPartial(
      object: DeepPartial<BulkTriggerWorkflowRequest>,
    ): BulkTriggerWorkflowRequest {
      const message = createBaseBulkTriggerWorkflowRequest();
      message.workflows =
        object.workflows?.map((e) => TriggerWorkflowRequest.fromPartial(e)) ||
        [];
      return message;
    },
  };
...
export const BulkTriggerWorkflowResponse: MessageFns<BulkTriggerWorkflowResponse> =
  {
    ...
    create(
      base?: DeepPartial<BulkTriggerWorkflowResponse>,
    ): BulkTriggerWorkflowResponse {
      return BulkTriggerWorkflowResponse.fromPartial(base ?? {});
    },
    fromPartial(
      object: DeepPartial<BulkTriggerWorkflowResponse>,
    ): BulkTriggerWorkflowResponse {
      const message = createBaseBulkTriggerWorkflowResponse();
...
export const TriggerWorkflowRequest: MessageFns<TriggerWorkflowRequest> = {
  ...
  fromPartial(
    object: DeepPartial<TriggerWorkflowRequest>,
  ): TriggerWorkflowRequest {
    const message = createBaseTriggerWorkflowRequest();
    message.name = object.name ?? "";
    message.input = object.input ?? "";
...
export const TriggerWorkflowResponse: MessageFns<TriggerWorkflowResponse> = {
  ...
  fromPartial(
    object: DeepPartial<TriggerWorkflowResponse>,
  ): TriggerWorkflowResponse {
    const message = createBaseTriggerWorkflowResponse();
