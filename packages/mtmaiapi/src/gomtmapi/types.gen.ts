...
export type WorkflowWorkersCount = {
    ...
    other?: ToolTypes | FlowNames | AgentTopicTypes | ComponentTypes | ProviderTypes | AgentEventType | AgentStateTypes | AgentTypes | FlowError | FlowTeamInput | CodeExecutionResult | SocialLoginInput | SocialLoginResult | FlowResult | SocialTeam | RootAgentState | AgentIncomingEvent | AgentOutgoingEvent | AddSessionToEvalSetRequest | AdkRawEvent | AdkAppTypes | Content | AgentRunRequestV3 | VideoParams;
};
...
export type ScheduledRunStatus = 'PENDING' | 'RUNNING' | 'SUCCEEDED' | 'FAILED' | 'CANCELLED' | 'QUEUED' | 'SCHEDULED';
...
export type WorkflowRunStatus = 'PENDING' | 'RUNNING' | 'SUCCEEDED' | 'FAILED' | 'CANCELLED' | 'QUEUED' | 'BACKOFF';
...
export type StepRunStatus = 'PENDING' | 'PENDING_ASSIGNMENT' | 'ASSIGNED' | 'RUNNING' | 'SUCCEEDED' | 'FAILED' | 'CANCELLED' | 'CANCELLING' | 'BACKOFF';
...
export type StepRunEventReason = 'REQUEUED_NO_WORKER' | 'REQUEUED_RATE_LIMIT' | 'SCHEDULING_TIMED_OUT' | 'ASSIGNED' | 'STARTED' | 'ACKNOWLEDGED' | 'FINISHED' | 'FAILED' | 'RETRYING' | 'CANCELLED' | 'TIMEOUT_REFRESHED' | 'REASSIGNED' | 'TIMED_OUT' | 'SLOT_RELEASED' | 'RETRIED_BY_USER' | 'WORKFLOW_RUN_GROUP_KEY_SUCCEEDED' | 'WORKFLOW_RUN_GROUP_KEY_FAILED';
...
export type AgentStateTypes = 'InstagramAgentState' | 'SocialTeamManagerState' | 'TeamState' | 'RuntimeState' | 'AssistantAgentState' | 'RoundRobinManagerState' | 'SelectorManagerState' | 'SwarmManagerState' | 'MagenticOneOrchestratorState' | 'SocietyOfMindAgentState' | 'ChatAgentContainerState' | 'BaseGroupChatManagerState';
...
export type ProviderTypes = 'SelectorGroupChat' | 'SocialTeam' | 'AssistantAgent' | 'InstagramAgent' | 'UserProxyAgent' | 'CodeExecutorAgent' | 'SocietyOfMindAgent' | 'OpenAIChatCompletionClient' | 'TextMentionTermination' | 'HandoffTermination' | 'TimeoutTermination' | 'SourceMatchTermination' | 'FunctionCallTermination' | 'TokenUsageTermination' | 'MaxMessageTermination' | 'StopMessageTermination' | 'TextMessageTermination';
...
export type FlowNames = 'sys' | 'tenant' | 'assistant' | 'ag' | 'browser' | 'resource' | 'instagram' | 'social' | 'team' | 'adk';
...
export type EventTypes = 'WorkflowRunStart' | 'WorkflowRunEnd' | 'StepRun' | 'TextMessage' | 'ModelClientStreamingChunkEvent' | 'EventNewAgentState';
...
export type AgentTypes = 'closure' | 'router' | 'user_proxy' | 'assistant' | 'social' | 'browser' | 'resource' | 'instagram';
...
export type LlmMessageTypes = 'AssistantMessage' | 'SystemMessage' | 'UserMessage' | 'FunctionExecutionResultMessage';
...
export type AgentEventType = 'ThoughtEvent' | 'TextMessage' | 'PlatformAccountFlowInput' | 'ChatMessageInput' | 'SocialAddFollowersInput' | 'SocialLoginInput' | 'TenantInitInput' | 'AskUserFunctionCallInput' | 'StartNewChatInput';
...
export type AgentTopicTypes = 'user' | 'human' | 'instagram' | 'browser' | 'socioety' | 'code' | 'router' | 'research' | 'writer' | 'tenant' | 'closure' | 'response';
...
export type TenantSettingsListResponse = TenantSettingsListResponses[keyof TenantSettingsListResponses];
...
export type TenantDefaultSettingGetError = TenantDefaultSettingGetErrors[keyof TenantDefaultSettingGetErrors];

export type TenantDefaultSettingGetResponses = {
    200: TenantSetting;
};

export type TenantDefaultSettingGetResponse = TenantDefaultSettingGetResponses[keyof TenantDefaultSettingGetResponses];
...
export type TenantDefaultSettingError = TenantDefaultSettingErrors[keyof TenantDefaultSettingErrors];

export type TenantDefaultSettingResponses = {
    200: TenantSetting;
};

export type TenantDefaultSettingResponse = TenantDefaultSettingResponses[keyof TenantDefaultSettingResponses];
...
export type TenantSettingsDeleteError = TenantSettingsDeleteErrors[keyof TenantSettingsDeleteErrors];
...
export type TenantSettingsDeleteResponse = TenantSettingsDeleteResponses[keyof TenantSettingsDeleteResponses];
...
export type TenantSettingsGetResponse = TenantSettingsGetResponses[keyof TenantSettingsGetResponses];
...
export type TenantSettingsUpsertError = TenantSettingsUpsertErrors[keyof TenantSettingsUpsertErrors];

export type TenantSettingsUpsertResponses = {
    200: TenantSetting;
};

export type TenantSettingsUpsertResponse = TenantSettingsUpsertResponses[keyof TenantSettingsUpsertResponses];
...
export type SlackWebhookDeleteResponse = SlackWebhookDeleteResponses[keyof SlackWebhookDeleteResponses];
...
export type TenantGetQueueMetricsError = TenantGetQueueMetricsErrors[keyof TenantGetQueueMetricsErrors];
...
export type TenantGetQueueMetricsResponse = TenantGetQueueMetricsResponses[keyof TenantGetQueueMetricsResponses];
...
export type TenantGetStepRunQueueMetricsError = TenantGetStepRunQueueMetricsErrors[keyof TenantGetStepRunQueueMetricsErrors];
...
export type TenantGetStepRunQueueMetricsResponse = TenantGetStepRunQueueMetricsResponses[keyof TenantGetStepRunQueueMetricsResponses];
...
export type EventUpdateCancelResponse = EventUpdateCancelResponses[keyof EventUpdateCancelResponses];
...
export type WorkflowScheduledListError = WorkflowScheduledListErrors[keyof WorkflowScheduledListErrors];
...
export type WorkflowScheduledListResponse = WorkflowScheduledListResponses[keyof WorkflowScheduledListResponses];
...
export type WorkflowScheduledDeleteError = WorkflowScheduledDeleteErrors[keyof WorkflowScheduledDeleteErrors];
...
export type WorkflowScheduledDeleteResponse = WorkflowScheduledDeleteResponses[keyof WorkflowScheduledDeleteResponses];
...
export type WorkflowScheduledGetError = WorkflowScheduledGetErrors[keyof WorkflowScheduledGetErrors];
...
export type WorkflowScheduledGetResponse = WorkflowScheduledGetResponses[keyof WorkflowScheduledGetResponses];
...
export type WorkflowVersionGetResponse = WorkflowVersionGetResponses[keyof WorkflowVersionGetResponses];
...
export type WorkflowGetMetricsResponse = WorkflowGetMetricsResponses[keyof WorkflowGetMetricsResponses];
...
export type StepRunListEventsResponse = StepRunListEventsResponses[keyof StepRunListEventsResponses];
...
export type WorkflowRunListStepRunEventsError = WorkflowRunListStepRunEventsErrors[keyof WorkflowRunListStepRunEventsErrors];
...
export type WorkflowRunListStepRunEventsResponse = WorkflowRunListStepRunEventsResponses[keyof WorkflowRunListStepRunEventsResponses];
...
export type StepRunListArchivesResponse = StepRunListArchivesResponses[keyof StepRunListArchivesResponses];
...
export type WorkflowGetWorkersCountError = WorkflowGetWorkersCountErrors[keyof WorkflowGetWorkersCountErrors];
...
export type WorkflowGetWorkersCountResponse = WorkflowGetWorkersCountResponses[keyof WorkflowGetWorkersCountResponses];
...
export type WorkflowRunUpdateReplayError = WorkflowRunUpdateReplayErrors[keyof WorkflowRunUpdateReplayErrors];
...
export type WorkflowRunUpdateReplayResponse = WorkflowRunUpdateReplayResponses[keyof WorkflowRunUpdateReplayResponses];
...
export type WorkflowRunGetMetricsError = WorkflowRunGetMetricsErrors[keyof WorkflowRunGetMetricsErrors];
...
export type WorkflowRunGetMetricsResponse = WorkflowRunGetMetricsResponses[keyof WorkflowRunGetMetricsResponses];
...
export type WorkflowRunGetShapeResponse = WorkflowRunGetShapeResponses[keyof WorkflowRunGetShapeResponses];
...
export type StepRunUpdateRerunResponse = StepRunUpdateRerunResponses[keyof StepRunUpdateRerunResponses];
...
export type StepRunUpdateCancelResponse = StepRunUpdateCancelResponses[keyof StepRunUpdateCancelResponses];
...
export type WebhookRequestsListResponse = WebhookRequestsListResponses[keyof WebhookRequestsListResponses];
...
export type WorkflowRunGetInputResponse = WorkflowRunGetInputResponses[keyof WorkflowRunGetInputResponses];
...
export type WorkflowGetByNameResponse = WorkflowGetByNameResponses[keyof WorkflowGetByNameResponses];
...
export type FrontendGetConfigResponse = FrontendGetConfigResponses[keyof FrontendGetConfigResponses];
...
export type FrontendGetSiderbarResponse = FrontendGetSiderbarResponses[keyof FrontendGetSiderbarResponses];
...
export type PlatformAccountListResponse = PlatformAccountListResponses[keyof PlatformAccountListResponses];
...
export type PlatformAccountCreateError = PlatformAccountCreateErrors[keyof PlatformAccountCreateErrors];

export type PlatformAccountCreateResponses = {
    200: PlatformAccount;
};

export type PlatformAccountCreateResponse = PlatformAccountCreateResponses[keyof PlatformAccountCreateResponses];
...
export type PlatformAccountGetResponse = PlatformAccountGetResponses[keyof PlatformAccountGetResponses];
...
export type PlatformAccountUpsertError = PlatformAccountUpsertErrors[keyof PlatformAccountUpsertErrors];
...
export type PlatformAccountUpsertResponse = PlatformAccountUpsertResponses[keyof PlatformAccountUpsertResponses];
...
export type ChatMessageUpsertResponse = ChatMessageUpsertResponses[keyof ChatMessageUpsertResponses];
...
export type ChatSessionUpsertResponse = ChatSessionUpsertResponses[keyof ChatSessionUpsertResponses];
...
export type AdkUserStateUpsertResponse = AdkUserStateUpsertResponses[keyof AdkUserStateUpsertResponses];
