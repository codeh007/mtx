...
export type WorkflowRunStatus = 'PENDING' | 'RUNNING' | 'SUCCEEDED' | 'FAILED' | 'CANCELLED' | 'QUEUED';
...
export type StepRunStatus = 'PENDING' | 'PENDING_ASSIGNMENT' | 'ASSIGNED' | 'RUNNING' | 'SUCCEEDED' | 'FAILED' | 'CANCELLED' | 'CANCELLING';
...
export type LanguageOptions = 'chinese' | 'english' | 'spanish' | 'french' | 'hindi';
...
export type FlowNames = 'research' | 'blogAuto' | 'tenant' | 'resourceAction' | 'oneShotDemo' | 'browser';
...
export type EventUpdateReplayResponse = EventUpdateReplayResponses[keyof EventUpdateReplayResponses];
...
export type ChatCallModelResponse = ChatCallModelResponses[keyof ChatCallModelResponses];
...
export type WorkerConfigResponse = WorkerConfigResponses[keyof WorkerConfigResponses];
...
export type MtmaiBloggenconfigResponse = MtmaiBloggenconfigResponses[keyof MtmaiBloggenconfigResponses];
...
export type MtmaiWorkerConfigResponse = MtmaiWorkerConfigResponses[keyof MtmaiWorkerConfigResponses];
...
export type MtmaiStreamDemo1Error = MtmaiStreamDemo1Errors[keyof MtmaiStreamDemo1Errors];

export type MtmaiStreamDemo1Responses = {
    200: string;
};

export type MtmaiStreamDemo1Response = MtmaiStreamDemo1Responses[keyof MtmaiStreamDemo1Responses];
...
export type ToolsOperationGuideResponse = ToolsOperationGuideResponses[keyof ToolsOperationGuideResponses];
...
export type ToolsWebsearchResponse = ToolsWebsearchResponses[keyof ToolsWebsearchResponses];
...
export type AgentNodeListResponse = AgentNodeListResponses[keyof AgentNodeListResponses];
...
export type AgentNodeUpdateError = AgentNodeUpdateErrors[keyof AgentNodeUpdateErrors];
...
export type AgentNodeUpdateResponse = AgentNodeUpdateResponses[keyof AgentNodeUpdateResponses];
...
export type AgentNodeRunResponse = AgentNodeRunResponses[keyof AgentNodeRunResponses];
...
export type AgentNodeFormResponse = AgentNodeFormResponses[keyof AgentNodeFormResponses];
...
export type AssisantListResponse = AssisantListResponses[keyof AssisantListResponses];
...
export type AssisantGetResponse = AssisantGetResponses[keyof AssisantGetResponses];
...
export type SubscribeSubscribeError = SubscribeSubscribeErrors[keyof SubscribeSubscribeErrors];
...
export type SubscribeSubscribeResponse = SubscribeSubscribeResponses[keyof SubscribeSubscribeResponses];
...
export type PlatformAccountUpdateError = PlatformAccountUpdateErrors[keyof PlatformAccountUpdateErrors];
...
export type PlatformAccountUpdateResponse = PlatformAccountUpdateResponses[keyof PlatformAccountUpdateResponses];
