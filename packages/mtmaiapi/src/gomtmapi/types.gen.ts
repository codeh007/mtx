...
export type AgEventV2 = EventNewAgentState | EventTypes | EventBase | StartWorkflowRunEvent | TokenChunk | AssisantState | GenArticleState;
...
export type TerminationTypes = 'MaxMessageTermination' | 'StopMessageTermination' | 'TextMentionTermination' | 'TimeoutTermination';
...
export type ComponentTypes = 'team' | 'agent' | 'model' | 'tool' | 'termination';
...
export type AgentMessageConfig = TextMessageConfig | StopMessageConfig | HandoffMessageConfig | ToolCallMessageConfig | ToolCallResultMessageConfig;
...
export type AgentTypes = 'AssistantAgent' | 'UserProxyAgent' | 'MultimodalWebSurfer' | 'FileSurfer' | 'MagenticOneCoderAgent';
...
export type TeamTypes = 'Assisant' | 'RoundRobinGroupChat' | 'SelectorGroupChat' | 'MagenticOneGroupChat';
...
export type AgentStreamResponse = AgentStreamResponses[keyof AgentStreamResponses];
...
export type AgEventCreateResponse = AgEventCreateResponses[keyof AgEventCreateResponses];
...
export type ChatCreateMessageError = ChatCreateMessageErrors[keyof ChatCreateMessageErrors];

export type ChatCreateMessageResponses = {
    200: ChatMessage;
};

export type ChatCreateMessageResponse = ChatCreateMessageResponses[keyof ChatCreateMessageResponses];
