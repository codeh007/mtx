...
export type AgentRunInput = {
    ...
    source?: string;
    topic?: string;
    other?: CodeWritingTask | CodeWritingResult | MyMessage | PlatformAccountTask | BrowserData | PlatformAccountData | InstagramTask | ChatSessionStartEvent | TeamRunnerTask | TerminationMessage | CodeReviewTask | CodeReviewResult | BrowserTask | BrowserOpenTask | MtTaskResult;
};
...
export type AgentMessageConfig = StopMessageConfig | HandoffMessageConfig | ToolCallMessageConfig | ToolCallResultMessageConfig;
