...
export const workerConfigQueryKey = (options?: Options<WorkerConfigData>) => createQueryKey('workerConfig', options);
...
export const mtmaiBloggenconfigQueryKey = (options?: Options<MtmaiBloggenconfigData>) => createQueryKey('mtmaiBloggenconfig', options);

export const mtmaiBloggenconfigOptions = (options?: Options<MtmaiBloggenconfigData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
...
export const mtmaiWorkerConfigQueryKey = (options?: Options<MtmaiWorkerConfigData>) => createQueryKey('mtmaiWorkerConfig', options);

export const mtmaiWorkerConfigOptions = (options?: Options<MtmaiWorkerConfigData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
...
export const modelCreateQueryKey = (options: Options<ModelCreateData>) => createQueryKey('modelCreate', options);
...
export const modelCreateMutation = (options?: Partial<Options<ModelCreateData>>) => {
    const mutationOptions: UseMutationOptions<ModelCreateResponse, ModelCreateError, Options<ModelCreateData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await modelCreate({
                ...options,
                ...localOptions,
...
export const modelUpdateMutation = (options?: Partial<Options<ModelUpdateData>>) => {
    const mutationOptions: UseMutationOptions<ModelUpdateResponse, ModelUpdateError, Options<ModelUpdateData>> = {
        mutationFn: async (localOptions) => {
...
export const platformAccountUpdateMutation = (options?: Partial<Options<PlatformAccountUpdateData>>) => {
    const mutationOptions: UseMutationOptions<PlatformAccountUpdateResponse, PlatformAccountUpdateError, Options<PlatformAccountUpdateData>> = {
        mutationFn: async (localOptions) => {
...
export const proxyCreateQueryKey = (options: Options<ProxyCreateData>) => createQueryKey('proxyCreate', options);
...
export const proxyCreateMutation = (options?: Partial<Options<ProxyCreateData>>) => {
    const mutationOptions: UseMutationOptions<ProxyCreateResponse, ProxyCreateError, Options<ProxyCreateData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await proxyCreate({
                ...options,
                ...localOptions,
...
export const proxyUpdateMutation = (options?: Partial<Options<ProxyUpdateData>>) => {
    const mutationOptions: UseMutationOptions<ProxyUpdateResponse, ProxyUpdateError, Options<ProxyUpdateData>> = {
        mutationFn: async (localOptions) => {
