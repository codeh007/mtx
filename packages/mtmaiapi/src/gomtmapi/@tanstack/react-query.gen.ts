...
import { type Options, readinessGet, livenessGet, metadataGet, cloudMetadataGet, metadataListIntegrations, userUpdateLogin, userUpdateGoogleOauthStart, userUpdateGoogleOauthCallback, userUpdateGithubOauthStart, userUpdateGithubOauthCallback, userUpdateSlackOauthStart, userUpdateSlackOauthCallback, tenantSettingsList, tenantDefaultSettingGet, tenantDefaultSetting, tenantSettingsDelete, tenantSettingsGet, tenantSettingsUpsert, snsList, snsCreate, alertEmailGroupList, alertEmailGroupCreate, tenantResourcePolicyGet, alertEmailGroupDelete, alertEmailGroupUpdate, snsDelete, slackWebhookList, slackWebhookDelete, userGetCurrent, userUpdatePassword, userCreate, userUpdateLogout, tenantMembershipsList, userListTenantInvites, tenantInviteAccept, tenantInviteReject, tenantCreate, tenantUpdate, tenantAlertingSettingsGet, tenantInviteList, tenantInviteCreate, tenantInviteDelete, tenantInviteUpdate, apiTokenList, apiTokenCreate, apiTokenUpdateRevoke, tenantGetQueueMetrics, tenantGetStepRunQueueMetrics, eventList, eventUpdateCancel, rateLimitList, tenantMemberList, tenantMemberDelete, eventGet, eventDataGet, eventKeyList, workflowList, workflowScheduledList, workflowScheduledDelete, workflowScheduledGet, cronWorkflowList, workflowRunCancel, workflowDelete, workflowGet, workflowUpdate, workflowVersionGet, workflowRunCreate, workflowGetMetrics, logLineList, stepRunListEvents, workflowRunListStepRunEvents, stepRunListArchives, workflowGetWorkersCount, workflowRunList, workflowRunUpdateReplay, workflowRunGetMetrics, workflowRunGet, workflowRunGetShape, stepRunGet, stepRunUpdateRerun, stepRunUpdateCancel, stepRunGetSchema, workerList, workerGet, workerUpdate, webhookList, webhookCreate, webhookDelete, webhookRequestsList, workflowRunGetInput, workflowGetByName, blogList, blogCreate, blogGet, blogUpdate, siteList, siteCreate, siteGet, siteUpdate, siteGetByHost, siteHostList, siteHostCreate, siteHostGet, siteHostUpdate, postListPublic, postGet, postList, postCreate, artifactList, artifactGet, comsList, comsUpsert, comsGet, galleryList, galleryCreate, galleryGet, agEventList, agEventGet, modelList, modelGet, modelUpsert, modelRunsList, modelRunGet, modelRunUpsert, promptList, promptGet, adminReleaseConn, adminResetDb, frontendGetConfig, frontendGetSiderbar, hfAccountGet, envList, envUpdate, envGet, endpointList, endpointUpdate, platformList, platformCreate, platformGet, platformUpdate, platformAccountList, platformAccountCreate, platformAccountGet, platformAccountUpsert, browserList, browserCreate, browserOpen, browserGet, browserUpdate, proxyList, proxyGet, proxyUpsert, agStateList, agStateGet, agStateUpsert, chatMessagesList, chatSessionList, chatMessageUpsert, chatSessionGet, chatSessionUpsert, flowStateList, flowStateGet, flowStateUpsert, uiAgentGet, dispatcherListen, resourceList, resourceUpsert, resourceDelete, resourceGet, instagramLogin, adkAppList, adkAppUpsert, adkAppGet, adkSessionList, adkSessionUpsert, adkSessionGet, adkUserStateList, adkUserStateUpsert, adkUserStateGet, adkEventsList, adkEventsUpsert, adkEventsGet, tkGetUserProfile, tkAccountLogin } from '../sdk.gen';
import { queryOptions, type UseMutationOptions, infiniteQueryOptions, type InfiniteData } from '@tanstack/react-query';
import type { ReadinessGetData, LivenessGetData, MetadataGetData, CloudMetadataGetData, MetadataListIntegrationsData, UserUpdateLoginData, UserUpdateLoginError, UserUpdateLoginResponse, UserUpdateGoogleOauthStartData, UserUpdateGoogleOauthCallbackData, UserUpdateGithubOauthStartData, UserUpdateGithubOauthCallbackData, UserUpdateSlackOauthStartData, UserUpdateSlackOauthCallbackData, TenantSettingsListData, TenantDefaultSettingGetData, TenantDefaultSettingData, TenantDefaultSettingError, TenantDefaultSettingResponse, TenantSettingsDeleteData, TenantSettingsDeleteError, TenantSettingsDeleteResponse, TenantSettingsGetData, TenantSettingsUpsertData, TenantSettingsUpsertError, TenantSettingsUpsertResponse, SnsListData, SnsCreateData, SnsCreateError, SnsCreateResponse, AlertEmailGroupListData, AlertEmailGroupCreateData, AlertEmailGroupCreateError, AlertEmailGroupCreateResponse, TenantResourcePolicyGetData, AlertEmailGroupDeleteData, AlertEmailGroupDeleteError, AlertEmailGroupDeleteResponse, AlertEmailGroupUpdateData, AlertEmailGroupUpdateError, AlertEmailGroupUpdateResponse, SnsDeleteData, SnsDeleteError, SnsDeleteResponse, SlackWebhookListData, SlackWebhookDeleteData, SlackWebhookDeleteError, SlackWebhookDeleteResponse, UserGetCurrentData, UserUpdatePasswordData, UserUpdatePasswordError, UserUpdatePasswordResponse, UserCreateData, UserCreateError, UserCreateResponse, UserUpdateLogoutData, UserUpdateLogoutError, UserUpdateLogoutResponse, TenantMembershipsListData, UserListTenantInvitesData, TenantInviteAcceptData, TenantInviteAcceptError, TenantInviteRejectData, TenantInviteRejectError, TenantCreateData, TenantCreateError, TenantCreateResponse, TenantUpdateData, TenantUpdateError, TenantUpdateResponse, TenantAlertingSettingsGetData, TenantInviteListData, TenantInviteCreateData, TenantInviteCreateError, TenantInviteCreateResponse, TenantInviteDeleteData, TenantInviteDeleteError, TenantInviteDeleteResponse, TenantInviteUpdateData, TenantInviteUpdateError, TenantInviteUpdateResponse, ApiTokenListData, ApiTokenCreateData, ApiTokenCreateError, ApiTokenCreateResponse, ApiTokenUpdateRevokeData, ApiTokenUpdateRevokeError, ApiTokenUpdateRevokeResponse, TenantGetQueueMetricsData, TenantGetStepRunQueueMetricsData, EventListData, EventListError, EventListResponse, EventUpdateCancelData, EventUpdateCancelError, EventUpdateCancelResponse, RateLimitListData, RateLimitListError, RateLimitListResponse, TenantMemberListData, TenantMemberDeleteData, TenantMemberDeleteError, TenantMemberDeleteResponse, EventGetData, EventDataGetData, EventKeyListData, WorkflowListData, WorkflowListError, WorkflowListResponse, WorkflowScheduledListData, WorkflowScheduledListError, WorkflowScheduledListResponse, WorkflowScheduledDeleteData, WorkflowScheduledDeleteError, WorkflowScheduledDeleteResponse, WorkflowScheduledGetData, CronWorkflowListData, CronWorkflowListError, CronWorkflowListResponse, WorkflowRunCancelData, WorkflowRunCancelError, WorkflowRunCancelResponse, WorkflowDeleteData, WorkflowDeleteError, WorkflowDeleteResponse, WorkflowGetData, WorkflowUpdateData, WorkflowUpdateError, WorkflowUpdateResponse, WorkflowVersionGetData, WorkflowRunCreateData, WorkflowRunCreateError, WorkflowRunCreateResponse, WorkflowGetMetricsData, LogLineListData, LogLineListError, LogLineListResponse, StepRunListEventsData, StepRunListEventsError, StepRunListEventsResponse, WorkflowRunListStepRunEventsData, StepRunListArchivesData, StepRunListArchivesError, StepRunListArchivesResponse, WorkflowGetWorkersCountData, WorkflowRunListData, WorkflowRunListError, WorkflowRunListResponse, WorkflowRunUpdateReplayData, WorkflowRunUpdateReplayError, WorkflowRunUpdateReplayResponse, WorkflowRunGetMetricsData, WorkflowRunGetData, WorkflowRunGetShapeData, StepRunGetData, StepRunUpdateRerunData, StepRunUpdateRerunError, StepRunUpdateRerunResponse, StepRunUpdateCancelData, StepRunUpdateCancelError, StepRunUpdateCancelResponse, StepRunGetSchemaData, WorkerListData, WorkerGetData, WorkerUpdateData, WorkerUpdateError, WorkerUpdateResponse, WebhookListData, WebhookCreateData, WebhookCreateError, WebhookCreateResponse, WebhookDeleteData, WebhookDeleteError, WebhookRequestsListData, WorkflowRunGetInputData, WorkflowGetByNameData, BlogListData, BlogCreateData, BlogCreateError, BlogCreateResponse, BlogGetData, BlogUpdateData, BlogUpdateError, BlogUpdateResponse, SiteListData, SiteCreateData, SiteCreateError, SiteCreateResponse, SiteGetData, SiteUpdateData, SiteUpdateError, SiteUpdateResponse, SiteGetByHostData, SiteHostListData, SiteHostListError, SiteHostListResponse, SiteHostCreateData, SiteHostCreateError, SiteHostCreateResponse, SiteHostGetData, SiteHostUpdateData, SiteHostUpdateError, SiteHostUpdateResponse, PostListPublicData, PostGetData, PostListData, PostCreateData, PostCreateError, PostCreateResponse, ArtifactListData, ArtifactGetData, ComsListData, ComsUpsertData, ComsUpsertError, ComsUpsertResponse, ComsGetData, GalleryListData, GalleryCreateData, GalleryCreateError, GalleryCreateResponse, GalleryGetData, AgEventListData, AgEventGetData, ModelListData, ModelGetData, ModelUpsertData, ModelUpsertError, ModelUpsertResponse, ModelRunsListData, ModelRunGetData, ModelRunUpsertData, ModelRunUpsertError, ModelRunUpsertResponse, PromptListData, PromptGetData, AdminReleaseConnData, AdminReleaseConnError, AdminReleaseConnResponse, AdminResetDbData, AdminResetDbError, AdminResetDbResponse, FrontendGetConfigData, FrontendGetSiderbarData, HfAccountGetData, EnvListData, EnvUpdateData, EnvUpdateError, EnvUpdateResponse, EnvGetData, EndpointListData, EndpointUpdateData, EndpointUpdateError, EndpointUpdateResponse, PlatformListData, PlatformCreateData, PlatformCreateError, PlatformCreateResponse, PlatformGetData, PlatformUpdateData, PlatformUpdateError, PlatformUpdateResponse, PlatformAccountListData, PlatformAccountCreateData, PlatformAccountCreateError, PlatformAccountCreateResponse, PlatformAccountGetData, PlatformAccountUpsertData, PlatformAccountUpsertError, PlatformAccountUpsertResponse, BrowserListData, BrowserCreateData, BrowserCreateError, BrowserCreateResponse, BrowserOpenData, BrowserOpenError, BrowserOpenResponse, BrowserGetData, BrowserUpdateData, BrowserUpdateError, BrowserUpdateResponse, ProxyListData, ProxyGetData, ProxyUpsertData, ProxyUpsertError, ProxyUpsertResponse, AgStateListData, AgStateGetData, AgStateUpsertData, AgStateUpsertError, AgStateUpsertResponse, ChatMessagesListData, ChatSessionListData, ChatMessageUpsertData, ChatMessageUpsertError, ChatMessageUpsertResponse, ChatSessionGetData, ChatSessionUpsertData, ChatSessionUpsertError, ChatSessionUpsertResponse, FlowStateListData, FlowStateGetData, FlowStateUpsertData, FlowStateUpsertError, FlowStateUpsertResponse, UiAgentGetData, DispatcherListenData, DispatcherListenError, DispatcherListenResponse, ResourceListData, ResourceListError, ResourceListResponse, ResourceUpsertData, ResourceUpsertError, ResourceUpsertResponse, ResourceDeleteData, ResourceDeleteError, ResourceDeleteResponse, ResourceGetData, InstagramLoginData, InstagramLoginError, InstagramLoginResponse, AdkAppListData, AdkAppUpsertData, AdkAppUpsertError, AdkAppUpsertResponse, AdkAppGetData, AdkSessionListData, AdkSessionUpsertData, AdkSessionUpsertError, AdkSessionUpsertResponse, AdkSessionGetData, AdkUserStateListData, AdkUserStateUpsertData, AdkUserStateUpsertError, AdkUserStateUpsertResponse, AdkUserStateGetData, AdkEventsListData, AdkEventsListError, AdkEventsListResponse, AdkEventsUpsertData, AdkEventsUpsertError, AdkEventsUpsertResponse, AdkEventsGetData, TkGetUserProfileData, TkGetUserProfileError, TkGetUserProfileResponse, TkAccountLoginData, TkAccountLoginError, TkAccountLoginResponse } from '../types.gen';
...
export const metadataListIntegrationsOptions = (options?: Options<MetadataListIntegrationsData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
...
export const userUpdateLoginQueryKey = (options?: Options<UserUpdateLoginData>) => createQueryKey('userUpdateLogin', options);
...
export const userUpdateGoogleOauthStartOptions = (options?: Options<UserUpdateGoogleOauthStartData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
...
export const userUpdateGoogleOauthCallbackOptions = (options?: Options<UserUpdateGoogleOauthCallbackData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
...
export const userUpdateGithubOauthStartOptions = (options?: Options<UserUpdateGithubOauthStartData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
...
export const userUpdateGithubOauthCallbackOptions = (options?: Options<UserUpdateGithubOauthCallbackData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
...
export const userUpdateSlackOauthStartOptions = (options: Options<UserUpdateSlackOauthStartData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
...
export const userUpdateSlackOauthCallbackOptions = (options?: Options<UserUpdateSlackOauthCallbackData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
...
export const tenantSettingsListQueryKey = (options: Options<TenantSettingsListData>) => createQueryKey('tenantSettingsList', options);
...
export const tenantDefaultSettingGetQueryKey = (options: Options<TenantDefaultSettingGetData>) => createQueryKey('tenantDefaultSettingGet', options);
...
export const tenantDefaultSettingQueryKey = (options: Options<TenantDefaultSettingData>) => createQueryKey('tenantDefaultSetting', options);
...
export const tenantDefaultSettingMutation = (options?: Partial<Options<TenantDefaultSettingData>>) => {
    const mutationOptions: UseMutationOptions<TenantDefaultSettingResponse, TenantDefaultSettingError, Options<TenantDefaultSettingData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await tenantDefaultSetting({
                ...options,
                ...localOptions,
...
export const tenantSettingsDeleteMutation = (options?: Partial<Options<TenantSettingsDeleteData>>) => {
    const mutationOptions: UseMutationOptions<TenantSettingsDeleteResponse, TenantSettingsDeleteError, Options<TenantSettingsDeleteData>> = {
        mutationFn: async (localOptions) => {
...
export const tenantSettingsGetQueryKey = (options: Options<TenantSettingsGetData>) => createQueryKey('tenantSettingsGet', options);
...
export const tenantSettingsUpsertQueryKey = (options: Options<TenantSettingsUpsertData>) => createQueryKey('tenantSettingsUpsert', options);
...
export const tenantSettingsUpsertMutation = (options?: Partial<Options<TenantSettingsUpsertData>>) => {
    const mutationOptions: UseMutationOptions<TenantSettingsUpsertResponse, TenantSettingsUpsertError, Options<TenantSettingsUpsertData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await tenantSettingsUpsert({
                ...options,
                ...localOptions,
...
export const snsCreateQueryKey = (options: Options<SnsCreateData>) => createQueryKey('snsCreate', options);
...
export const alertEmailGroupCreateQueryKey = (options: Options<AlertEmailGroupCreateData>) => createQueryKey('alertEmailGroupCreate', options);
...
export const alertEmailGroupCreateMutation = (options?: Partial<Options<AlertEmailGroupCreateData>>) => {
...
export const alertEmailGroupDeleteMutation = (options?: Partial<Options<AlertEmailGroupDeleteData>>) => {
...
export const alertEmailGroupUpdateMutation = (options?: Partial<Options<AlertEmailGroupUpdateData>>) => {
...
export const userUpdatePasswordQueryKey = (options?: Options<UserUpdatePasswordData>) => createQueryKey('userUpdatePassword', options);
...
export const userUpdateLogoutQueryKey = (options?: Options<UserUpdateLogoutData>) => createQueryKey('userUpdateLogout', options);
...
export const tenantInviteAcceptQueryKey = (options?: Options<TenantInviteAcceptData>) => createQueryKey('tenantInviteAccept', options);
...
export const tenantInviteRejectQueryKey = (options?: Options<TenantInviteRejectData>) => createQueryKey('tenantInviteReject', options);
...
export const tenantAlertingSettingsGetOptions = (options: Options<TenantAlertingSettingsGetData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
...
export const tenantInviteCreateQueryKey = (options: Options<TenantInviteCreateData>) => createQueryKey('tenantInviteCreate', options);
...
export const apiTokenCreateQueryKey = (options: Options<ApiTokenCreateData>) => createQueryKey('apiTokenCreate', options);
...
export const apiTokenUpdateRevokeQueryKey = (options: Options<ApiTokenUpdateRevokeData>) => createQueryKey('apiTokenUpdateRevoke', options);
...
export const apiTokenUpdateRevokeMutation = (options?: Partial<Options<ApiTokenUpdateRevokeData>>) => {
...
export const tenantGetStepRunQueueMetricsOptions = (options: Options<TenantGetStepRunQueueMetricsData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
...
export const eventListInfiniteOptions = (options: Options<EventListData>) => {
    return infiniteQueryOptions<EventListResponse, EventListError, InfiniteData<EventListResponse>, QueryKey<Options<EventListData>>, number | Pick<QueryKey<Options<EventListData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
...
export const eventUpdateCancelQueryKey = (options: Options<EventUpdateCancelData>) => createQueryKey('eventUpdateCancel', options);
...
export const rateLimitListInfiniteOptions = (options: Options<RateLimitListData>) => {
    return infiniteQueryOptions<RateLimitListResponse, RateLimitListError, InfiniteData<RateLimitListResponse>, QueryKey<Options<RateLimitListData>>, number | Pick<QueryKey<Options<RateLimitListData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
...
export const workflowListInfiniteOptions = (options: Options<WorkflowListData>) => {
    return infiniteQueryOptions<WorkflowListResponse, WorkflowListError, InfiniteData<WorkflowListResponse>, QueryKey<Options<WorkflowListData>>, number | Pick<QueryKey<Options<WorkflowListData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
...
export const workflowScheduledListInfiniteOptions = (options: Options<WorkflowScheduledListData>) => {
    return infiniteQueryOptions<WorkflowScheduledListResponse, WorkflowScheduledListError, InfiniteData<WorkflowScheduledListResponse>, QueryKey<Options<WorkflowScheduledListData>>, number | Pick<QueryKey<Options<WorkflowScheduledListData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
...
export const workflowScheduledDeleteMutation = (options?: Partial<Options<WorkflowScheduledDeleteData>>) => {
...
export const cronWorkflowListInfiniteOptions = (options: Options<CronWorkflowListData>) => {
    return infiniteQueryOptions<CronWorkflowListResponse, CronWorkflowListError, InfiniteData<CronWorkflowListResponse>, QueryKey<Options<CronWorkflowListData>>, number | Pick<QueryKey<Options<CronWorkflowListData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
...
export const workflowRunCancelQueryKey = (options: Options<WorkflowRunCancelData>) => createQueryKey('workflowRunCancel', options);
...
export const workflowRunCreateQueryKey = (options: Options<WorkflowRunCreateData>) => createQueryKey('workflowRunCreate', options);
...
export const logLineListInfiniteOptions = (options: Options<LogLineListData>) => {
    return infiniteQueryOptions<LogLineListResponse, LogLineListError, InfiniteData<LogLineListResponse>, QueryKey<Options<LogLineListData>>, number | Pick<QueryKey<Options<LogLineListData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
...
export const stepRunListEventsInfiniteOptions = (options: Options<StepRunListEventsData>) => {
    return infiniteQueryOptions<StepRunListEventsResponse, StepRunListEventsError, InfiniteData<StepRunListEventsResponse>, QueryKey<Options<StepRunListEventsData>>, number | Pick<QueryKey<Options<StepRunListEventsData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
...
export const workflowRunListStepRunEventsOptions = (options: Options<WorkflowRunListStepRunEventsData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
...
export const stepRunListArchivesInfiniteOptions = (options: Options<StepRunListArchivesData>) => {
    return infiniteQueryOptions<StepRunListArchivesResponse, StepRunListArchivesError, InfiniteData<StepRunListArchivesResponse>, QueryKey<Options<StepRunListArchivesData>>, number | Pick<QueryKey<Options<StepRunListArchivesData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
...
export const workflowRunListInfiniteOptions = (options: Options<WorkflowRunListData>) => {
    return infiniteQueryOptions<WorkflowRunListResponse, WorkflowRunListError, InfiniteData<WorkflowRunListResponse>, QueryKey<Options<WorkflowRunListData>>, number | Pick<QueryKey<Options<WorkflowRunListData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
...
export const workflowRunUpdateReplayQueryKey = (options: Options<WorkflowRunUpdateReplayData>) => createQueryKey('workflowRunUpdateReplay', options);
...
export const workflowRunUpdateReplayMutation = (options?: Partial<Options<WorkflowRunUpdateReplayData>>) => {
...
export const stepRunUpdateRerunQueryKey = (options: Options<StepRunUpdateRerunData>) => createQueryKey('stepRunUpdateRerun', options);
...
export const stepRunUpdateCancelQueryKey = (options: Options<StepRunUpdateCancelData>) => createQueryKey('stepRunUpdateCancel', options);
...
export const stepRunUpdateCancelMutation = (options?: Partial<Options<StepRunUpdateCancelData>>) => {
...
export const webhookCreateQueryKey = (options: Options<WebhookCreateData>) => createQueryKey('webhookCreate', options);
...
export const workflowGetByNameQueryKey = (options: Options<WorkflowGetByNameData>) => createQueryKey('workflowGetByName', options);
...
export const blogListQueryKey = (options: Options<BlogListData>) => createQueryKey('blogList', options);
...
export const blogCreateQueryKey = (options: Options<BlogCreateData>) => createQueryKey('blogCreate', options);
...
export const blogCreateMutation = (options?: Partial<Options<BlogCreateData>>) => {
    const mutationOptions: UseMutationOptions<BlogCreateResponse, BlogCreateError, Options<BlogCreateData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await blogCreate({
                ...options,
                ...localOptions,
...
export const blogGetQueryKey = (options: Options<BlogGetData>) => createQueryKey('blogGet', options);
...
export const blogUpdateMutation = (options?: Partial<Options<BlogUpdateData>>) => {
    const mutationOptions: UseMutationOptions<BlogUpdateResponse, BlogUpdateError, Options<BlogUpdateData>> = {
        mutationFn: async (localOptions) => {
...
export const siteListQueryKey = (options: Options<SiteListData>) => createQueryKey('siteList', options);
...
export const siteCreateQueryKey = (options: Options<SiteCreateData>) => createQueryKey('siteCreate', options);
...
export const siteCreateMutation = (options?: Partial<Options<SiteCreateData>>) => {
    const mutationOptions: UseMutationOptions<SiteCreateResponse, SiteCreateError, Options<SiteCreateData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await siteCreate({
                ...options,
                ...localOptions,
...
export const siteGetQueryKey = (options: Options<SiteGetData>) => createQueryKey('siteGet', options);
...
export const siteUpdateMutation = (options?: Partial<Options<SiteUpdateData>>) => {
    const mutationOptions: UseMutationOptions<SiteUpdateResponse, SiteUpdateError, Options<SiteUpdateData>> = {
        mutationFn: async (localOptions) => {
...
export const siteGetByHostQueryKey = (options: Options<SiteGetByHostData>) => createQueryKey('siteGetByHost', options);
...
export const siteHostListQueryKey = (options: Options<SiteHostListData>) => createQueryKey('siteHostList', options);
...
export const siteHostListInfiniteQueryKey = (options: Options<SiteHostListData>): QueryKey<Options<SiteHostListData>> => createQueryKey('siteHostList', options, true);

export const siteHostListInfiniteOptions = (options: Options<SiteHostListData>) => {
    return infiniteQueryOptions<SiteHostListResponse, SiteHostListError, InfiniteData<SiteHostListResponse>, QueryKey<Options<SiteHostListData>>, number | Pick<QueryKey<Options<SiteHostListData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
            const page: Pick<QueryKey<Options<SiteHostListData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
                query: {
                    offset: pageParam
                }
            };
...
export const siteHostCreateQueryKey = (options: Options<SiteHostCreateData>) => createQueryKey('siteHostCreate', options);
...
export const siteHostCreateMutation = (options?: Partial<Options<SiteHostCreateData>>) => {
    const mutationOptions: UseMutationOptions<SiteHostCreateResponse, SiteHostCreateError, Options<SiteHostCreateData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await siteHostCreate({
                ...options,
                ...localOptions,
...
export const siteHostGetQueryKey = (options: Options<SiteHostGetData>) => createQueryKey('siteHostGet', options);
...
export const siteHostUpdateMutation = (options?: Partial<Options<SiteHostUpdateData>>) => {
    const mutationOptions: UseMutationOptions<SiteHostUpdateResponse, SiteHostUpdateError, Options<SiteHostUpdateData>> = {
        mutationFn: async (localOptions) => {
...
export const postListPublicQueryKey = (options?: Options<PostListPublicData>) => createQueryKey('postListPublic', options);
...
export const postListQueryKey = (options: Options<PostListData>) => createQueryKey('postList', options);
...
export const postCreateQueryKey = (options: Options<PostCreateData>) => createQueryKey('postCreate', options);
...
export const artifactListQueryKey = (options: Options<ArtifactListData>) => createQueryKey('artifactList', options);
...
export const artifactGetQueryKey = (options: Options<ArtifactGetData>) => createQueryKey('artifactGet', options);
...
export const comsListQueryKey = (options: Options<ComsListData>) => createQueryKey('comsList', options);
...
export const comsUpsertMutation = (options?: Partial<Options<ComsUpsertData>>) => {
    const mutationOptions: UseMutationOptions<ComsUpsertResponse, ComsUpsertError, Options<ComsUpsertData>> = {
        mutationFn: async (localOptions) => {
...
export const comsGetQueryKey = (options: Options<ComsGetData>) => createQueryKey('comsGet', options);
...
export const galleryListQueryKey = (options: Options<GalleryListData>) => createQueryKey('galleryList', options);
...
export const galleryCreateQueryKey = (options: Options<GalleryCreateData>) => createQueryKey('galleryCreate', options);
...
export const galleryCreateMutation = (options?: Partial<Options<GalleryCreateData>>) => {
    const mutationOptions: UseMutationOptions<GalleryCreateResponse, GalleryCreateError, Options<GalleryCreateData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await galleryCreate({
                ...options,
                ...localOptions,
...
export const galleryGetQueryKey = (options: Options<GalleryGetData>) => createQueryKey('galleryGet', options);
...
export const agEventListQueryKey = (options: Options<AgEventListData>) => createQueryKey('agEventList', options);
...
export const agEventGetQueryKey = (options: Options<AgEventGetData>) => createQueryKey('agEventGet', options);
...
export const modelListQueryKey = (options: Options<ModelListData>) => createQueryKey('modelList', options);
...
export const modelGetQueryKey = (options: Options<ModelGetData>) => createQueryKey('modelGet', options);
...
export const modelUpsertMutation = (options?: Partial<Options<ModelUpsertData>>) => {
    const mutationOptions: UseMutationOptions<ModelUpsertResponse, ModelUpsertError, Options<ModelUpsertData>> = {
        mutationFn: async (localOptions) => {
...
export const modelRunsListQueryKey = (options: Options<ModelRunsListData>) => createQueryKey('modelRunsList', options);
...
export const modelRunGetQueryKey = (options: Options<ModelRunGetData>) => createQueryKey('modelRunGet', options);
...
export const modelRunUpsertMutation = (options?: Partial<Options<ModelRunUpsertData>>) => {
    const mutationOptions: UseMutationOptions<ModelRunUpsertResponse, ModelRunUpsertError, Options<ModelRunUpsertData>> = {
        mutationFn: async (localOptions) => {
...
export const promptListQueryKey = (options: Options<PromptListData>) => createQueryKey('promptList', options);
...
export const promptGetQueryKey = (options: Options<PromptGetData>) => createQueryKey('promptGet', options);
...
export const adminReleaseConnQueryKey = (options?: Options<AdminReleaseConnData>) => createQueryKey('adminReleaseConn', options);
...
export const adminReleaseConnMutation = (options?: Partial<Options<AdminReleaseConnData>>) => {
    const mutationOptions: UseMutationOptions<AdminReleaseConnResponse, AdminReleaseConnError, Options<AdminReleaseConnData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await adminReleaseConn({
                ...options,
                ...localOptions,
...
export const adminResetDbQueryKey = (options?: Options<AdminResetDbData>) => createQueryKey('adminResetDb', options);
...
export const adminResetDbMutation = (options?: Partial<Options<AdminResetDbData>>) => {
    const mutationOptions: UseMutationOptions<AdminResetDbResponse, AdminResetDbError, Options<AdminResetDbData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await adminResetDb({
                ...options,
                ...localOptions,
...
export const frontendGetConfigQueryKey = (options?: Options<FrontendGetConfigData>) => createQueryKey('frontendGetConfig', options);
...
export const frontendGetSiderbarQueryKey = (options?: Options<FrontendGetSiderbarData>) => createQueryKey('frontendGetSiderbar', options);
...
export const hfAccountGetQueryKey = (options?: Options<HfAccountGetData>) => createQueryKey('hfAccountGet', options);
...
export const envListQueryKey = (options?: Options<EnvListData>) => createQueryKey('envList', options);
...
export const envUpdateMutation = (options?: Partial<Options<EnvUpdateData>>) => {
    const mutationOptions: UseMutationOptions<EnvUpdateResponse, EnvUpdateError, Options<EnvUpdateData>> = {
        mutationFn: async (localOptions) => {
...
export const endpointListQueryKey = (options?: Options<EndpointListData>) => createQueryKey('endpointList', options);
...
export const endpointUpdateMutation = (options?: Partial<Options<EndpointUpdateData>>) => {
    const mutationOptions: UseMutationOptions<EndpointUpdateResponse, EndpointUpdateError, Options<EndpointUpdateData>> = {
        mutationFn: async (localOptions) => {
...
export const platformListQueryKey = (options: Options<PlatformListData>) => createQueryKey('platformList', options);
...
export const platformCreateQueryKey = (options: Options<PlatformCreateData>) => createQueryKey('platformCreate', options);
...
export const platformCreateMutation = (options?: Partial<Options<PlatformCreateData>>) => {
    const mutationOptions: UseMutationOptions<PlatformCreateResponse, PlatformCreateError, Options<PlatformCreateData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await platformCreate({
                ...options,
                ...localOptions,
...
export const platformGetQueryKey = (options: Options<PlatformGetData>) => createQueryKey('platformGet', options);
...
export const platformUpdateMutation = (options?: Partial<Options<PlatformUpdateData>>) => {
    const mutationOptions: UseMutationOptions<PlatformUpdateResponse, PlatformUpdateError, Options<PlatformUpdateData>> = {
        mutationFn: async (localOptions) => {
...
export const platformAccountListQueryKey = (options: Options<PlatformAccountListData>) => createQueryKey('platformAccountList', options);
...
export const platformAccountCreateQueryKey = (options: Options<PlatformAccountCreateData>) => createQueryKey('platformAccountCreate', options);
...
export const platformAccountCreateMutation = (options?: Partial<Options<PlatformAccountCreateData>>) => {
    const mutationOptions: UseMutationOptions<PlatformAccountCreateResponse, PlatformAccountCreateError, Options<PlatformAccountCreateData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await platformAccountCreate({
                ...options,
                ...localOptions,
...
export const platformAccountGetQueryKey = (options: Options<PlatformAccountGetData>) => createQueryKey('platformAccountGet', options);
...
export const platformAccountUpsertMutation = (options?: Partial<Options<PlatformAccountUpsertData>>) => {
    const mutationOptions: UseMutationOptions<PlatformAccountUpsertResponse, PlatformAccountUpsertError, Options<PlatformAccountUpsertData>> = {
        mutationFn: async (localOptions) => {
...
export const browserListQueryKey = (options: Options<BrowserListData>) => createQueryKey('browserList', options);
...
export const browserCreateQueryKey = (options: Options<BrowserCreateData>) => createQueryKey('browserCreate', options);
...
export const browserCreateMutation = (options?: Partial<Options<BrowserCreateData>>) => {
    const mutationOptions: UseMutationOptions<BrowserCreateResponse, BrowserCreateError, Options<BrowserCreateData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await browserCreate({
                ...options,
                ...localOptions,
...
export const browserOpenQueryKey = (options: Options<BrowserOpenData>) => createQueryKey('browserOpen', options);
...
export const browserOpenMutation = (options?: Partial<Options<BrowserOpenData>>) => {
    const mutationOptions: UseMutationOptions<BrowserOpenResponse, BrowserOpenError, Options<BrowserOpenData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await browserOpen({
                ...options,
                ...localOptions,
...
export const browserGetQueryKey = (options: Options<BrowserGetData>) => createQueryKey('browserGet', options);
...
export const browserUpdateMutation = (options?: Partial<Options<BrowserUpdateData>>) => {
    const mutationOptions: UseMutationOptions<BrowserUpdateResponse, BrowserUpdateError, Options<BrowserUpdateData>> = {
        mutationFn: async (localOptions) => {
...
export const proxyListQueryKey = (options: Options<ProxyListData>) => createQueryKey('proxyList', options);
...
export const proxyGetQueryKey = (options: Options<ProxyGetData>) => createQueryKey('proxyGet', options);
...
export const proxyUpsertMutation = (options?: Partial<Options<ProxyUpsertData>>) => {
    const mutationOptions: UseMutationOptions<ProxyUpsertResponse, ProxyUpsertError, Options<ProxyUpsertData>> = {
        mutationFn: async (localOptions) => {
...
export const agStateListQueryKey = (options: Options<AgStateListData>) => createQueryKey('agStateList', options);
...
export const agStateGetQueryKey = (options: Options<AgStateGetData>) => createQueryKey('agStateGet', options);
...
export const agStateUpsertMutation = (options?: Partial<Options<AgStateUpsertData>>) => {
    const mutationOptions: UseMutationOptions<AgStateUpsertResponse, AgStateUpsertError, Options<AgStateUpsertData>> = {
        mutationFn: async (localOptions) => {
...
export const chatMessagesListQueryKey = (options: Options<ChatMessagesListData>) => createQueryKey('chatMessagesList', options);
...
export const chatSessionListQueryKey = (options: Options<ChatSessionListData>) => createQueryKey('chatSessionList', options);
...
export const chatMessageUpsertQueryKey = (options: Options<ChatMessageUpsertData>) => createQueryKey('chatMessageUpsert', options);
...
export const chatMessageUpsertMutation = (options?: Partial<Options<ChatMessageUpsertData>>) => {
    const mutationOptions: UseMutationOptions<ChatMessageUpsertResponse, ChatMessageUpsertError, Options<ChatMessageUpsertData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await chatMessageUpsert({
                ...options,
                ...localOptions,
...
export const chatSessionGetQueryKey = (options: Options<ChatSessionGetData>) => createQueryKey('chatSessionGet', options);
...
export const chatSessionUpsertMutation = (options?: Partial<Options<ChatSessionUpsertData>>) => {
    const mutationOptions: UseMutationOptions<ChatSessionUpsertResponse, ChatSessionUpsertError, Options<ChatSessionUpsertData>> = {
        mutationFn: async (localOptions) => {
...
export const flowStateListQueryKey = (options: Options<FlowStateListData>) => createQueryKey('flowStateList', options);
...
export const flowStateGetQueryKey = (options: Options<FlowStateGetData>) => createQueryKey('flowStateGet', options);
...
export const flowStateUpsertMutation = (options?: Partial<Options<FlowStateUpsertData>>) => {
    const mutationOptions: UseMutationOptions<FlowStateUpsertResponse, FlowStateUpsertError, Options<FlowStateUpsertData>> = {
        mutationFn: async (localOptions) => {
...
export const uiAgentGetQueryKey = (options: Options<UiAgentGetData>) => createQueryKey('uiAgentGet', options);
...
export const dispatcherListenQueryKey = (options: Options<DispatcherListenData>) => createQueryKey('dispatcherListen', options);
...
export const dispatcherListenMutation = (options?: Partial<Options<DispatcherListenData>>) => {
    const mutationOptions: UseMutationOptions<DispatcherListenResponse, DispatcherListenError, Options<DispatcherListenData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await dispatcherListen({
                ...options,
                ...localOptions,
...
export const resourceListQueryKey = (options: Options<ResourceListData>) => createQueryKey('resourceList', options);
...
export const resourceListInfiniteQueryKey = (options: Options<ResourceListData>): QueryKey<Options<ResourceListData>> => createQueryKey('resourceList', options, true);

export const resourceListInfiniteOptions = (options: Options<ResourceListData>) => {
    return infiniteQueryOptions<ResourceListResponse, ResourceListError, InfiniteData<ResourceListResponse>, QueryKey<Options<ResourceListData>>, number | Pick<QueryKey<Options<ResourceListData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
            const page: Pick<QueryKey<Options<ResourceListData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
                query: {
                    offset: pageParam
                }
            };
...
export const resourceUpsertQueryKey = (options: Options<ResourceUpsertData>) => createQueryKey('resourceUpsert', options);
...
export const resourceUpsertMutation = (options?: Partial<Options<ResourceUpsertData>>) => {
    const mutationOptions: UseMutationOptions<ResourceUpsertResponse, ResourceUpsertError, Options<ResourceUpsertData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await resourceUpsert({
                ...options,
                ...localOptions,
...
export const resourceDeleteMutation = (options?: Partial<Options<ResourceDeleteData>>) => {
    const mutationOptions: UseMutationOptions<ResourceDeleteResponse, ResourceDeleteError, Options<ResourceDeleteData>> = {
        mutationFn: async (localOptions) => {
...
export const resourceGetQueryKey = (options: Options<ResourceGetData>) => createQueryKey('resourceGet', options);
...
export const instagramLoginQueryKey = (options?: Options<InstagramLoginData>) => createQueryKey('instagramLogin', options);
...
export const instagramLoginMutation = (options?: Partial<Options<InstagramLoginData>>) => {
    const mutationOptions: UseMutationOptions<InstagramLoginResponse, InstagramLoginError, Options<InstagramLoginData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await instagramLogin({
                ...options,
                ...localOptions,
...
export const adkAppListQueryKey = (options: Options<AdkAppListData>) => createQueryKey('adkAppList', options);
...
export const adkAppUpsertQueryKey = (options: Options<AdkAppUpsertData>) => createQueryKey('adkAppUpsert', options);
...
export const adkAppUpsertMutation = (options?: Partial<Options<AdkAppUpsertData>>) => {
    const mutationOptions: UseMutationOptions<AdkAppUpsertResponse, AdkAppUpsertError, Options<AdkAppUpsertData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await adkAppUpsert({
                ...options,
                ...localOptions,
...
export const adkAppGetQueryKey = (options: Options<AdkAppGetData>) => createQueryKey('adkAppGet', options);
...
export const adkSessionListQueryKey = (options: Options<AdkSessionListData>) => createQueryKey('adkSessionList', options);
...
export const adkSessionUpsertQueryKey = (options: Options<AdkSessionUpsertData>) => createQueryKey('adkSessionUpsert', options);
...
export const adkSessionUpsertMutation = (options?: Partial<Options<AdkSessionUpsertData>>) => {
    const mutationOptions: UseMutationOptions<AdkSessionUpsertResponse, AdkSessionUpsertError, Options<AdkSessionUpsertData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await adkSessionUpsert({
                ...options,
                ...localOptions,
...
export const adkSessionGetQueryKey = (options: Options<AdkSessionGetData>) => createQueryKey('adkSessionGet', options);
...
export const adkUserStateListQueryKey = (options: Options<AdkUserStateListData>) => createQueryKey('adkUserStateList', options);
...
export const adkUserStateUpsertQueryKey = (options: Options<AdkUserStateUpsertData>) => createQueryKey('adkUserStateUpsert', options);
...
export const adkUserStateUpsertMutation = (options?: Partial<Options<AdkUserStateUpsertData>>) => {
    const mutationOptions: UseMutationOptions<AdkUserStateUpsertResponse, AdkUserStateUpsertError, Options<AdkUserStateUpsertData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await adkUserStateUpsert({
                ...options,
                ...localOptions,
...
export const adkUserStateGetQueryKey = (options: Options<AdkUserStateGetData>) => createQueryKey('adkUserStateGet', options);
...
export const adkEventsListQueryKey = (options: Options<AdkEventsListData>) => createQueryKey('adkEventsList', options);
...
export const adkEventsListInfiniteQueryKey = (options: Options<AdkEventsListData>): QueryKey<Options<AdkEventsListData>> => createQueryKey('adkEventsList', options, true);

export const adkEventsListInfiniteOptions = (options: Options<AdkEventsListData>) => {
    return infiniteQueryOptions<AdkEventsListResponse, AdkEventsListError, InfiniteData<AdkEventsListResponse>, QueryKey<Options<AdkEventsListData>>, number | Pick<QueryKey<Options<AdkEventsListData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
            const page: Pick<QueryKey<Options<AdkEventsListData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
                query: {
                    offset: pageParam
                }
            };
...
export const adkEventsUpsertQueryKey = (options: Options<AdkEventsUpsertData>) => createQueryKey('adkEventsUpsert', options);
...
export const adkEventsUpsertMutation = (options?: Partial<Options<AdkEventsUpsertData>>) => {
    const mutationOptions: UseMutationOptions<AdkEventsUpsertResponse, AdkEventsUpsertError, Options<AdkEventsUpsertData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await adkEventsUpsert({
                ...options,
                ...localOptions,
...
export const adkEventsGetQueryKey = (options: Options<AdkEventsGetData>) => createQueryKey('adkEventsGet', options);
...
export const tkGetUserProfileQueryKey = (options: Options<TkGetUserProfileData>) => createQueryKey('tkGetUserProfile', options);
...
export const tkGetUserProfileMutation = (options?: Partial<Options<TkGetUserProfileData>>) => {
    const mutationOptions: UseMutationOptions<TkGetUserProfileResponse, TkGetUserProfileError, Options<TkGetUserProfileData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await tkGetUserProfile({
                ...options,
                ...localOptions,
...
export const tkAccountLoginQueryKey = (options: Options<TkAccountLoginData>) => createQueryKey('tkAccountLogin', options);
...
export const tkAccountLoginMutation = (options?: Partial<Options<TkAccountLoginData>>) => {
    const mutationOptions: UseMutationOptions<TkAccountLoginResponse, TkAccountLoginError, Options<TkAccountLoginData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await tkAccountLogin({
                ...options,
                ...localOptions,
