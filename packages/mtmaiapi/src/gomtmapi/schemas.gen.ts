...
export const ScheduledWorkflowsSchema = {
    ...
    required: ['metadata', 'tenantId', 'workflowVersionId', 'workflowName', 'workflowId', 'triggerAt']
} as const;
...
export const CronWorkflowsSchema = {
    ...
    required: ['metadata', 'tenantId', 'workflowVersionId', 'workflowName', 'workflowId', 'cron']
} as const;
...
export const StepRunStatusSchema = {
    type: 'string',
    enum: ['PENDING', 'PENDING_ASSIGNMENT', 'ASSIGNED', 'RUNNING', 'SUCCEEDED', 'FAILED', 'CANCELLED', 'CANCELLING']
} as const;
...
export const StartWorkflowRunEventSchema = {
    description: '用户调用工作流后, 后端返回工作流启动状态的事件, 一般用于根据 Id,从 stream api 中进一步拉取更加详细的事件',
    allOf: [
        {
            '$ref': '#/components/schemas/EventBase'
        },
