...
export const AgentStateTypesSchema = {
    type: 'string',
    enum: ['InstagramAgentState', 'SocialTeamManagerState', 'TeamState', 'RuntimeState', 'AssistantAgentState', 'RoundRobinManagerState', 'SelectorManagerState', 'SwarmManagerState', 'MagenticOneOrchestratorState', 'SocietyOfMindAgentState', 'ChatAgentContainerState', 'BaseGroupChatManagerState']
} as const;
...
export const ComponentPropertiesSchema = {
    required: ['label', 'description', 'provider', 'component_type', 'version', 'component_version', 'component', 'config'],
    properties: {
        label: {
            type: 'string'
        },
...
export const AssistantAgentConfigSchema = {
    required: ['name', 'description', 'model_client', 'tools', 'tool_call_summary_format', 'reflect_on_tool_use'],
    properties: {
        name: {
            type: 'string'
        },
...
export const FlowNamesSchema = {
    type: 'string',
    enum: ['sys', 'tenant', 'assistant', 'ag', 'browser', 'resource', 'instagram', 'social', 'team', 'adk']
} as const;
...
export const AgentTypesSchema = {
    type: 'string',
    enum: ['closure', 'router', 'user_proxy', 'assistant', 'social', 'browser', 'resource', 'instagram']
} as const;
...
export const ModelPropertiesSchema = {
    required: ['name', 'family', 'provider', 'vendor', 'vision', 'functionCalling', 'jsonOutput', 'apiKey', 'apiBase', 'model'],
    properties: {
        name: {
            type: 'string'
        },
...
export const AgentEventTypeSchema = {
    type: 'string',
    enum: ['ThoughtEvent', 'TextMessage', 'PlatformAccountFlowInput', 'ChatMessageInput', 'SocialAddFollowersInput', 'SocialLoginInput', 'TenantInitInput', 'AskUserFunctionCallInput', 'StartNewChatInput']
} as const;
...
export const AgentTopicTypesSchema = {
    type: 'string',
    enum: ['user', 'human', 'instagram', 'browser', 'socioety', 'code', 'router', 'research', 'writer', 'tenant', 'closure', 'response']
} as const;
...
export const AdkEventPropertiesSchema = {
    required: ['id', 'app_name', 'user_id', 'session_id', 'invocation_id', 'author', 'timestamp', 'content', 'actions'],
    properties: {
        id: {
            type: 'string'
        },
...
export const AdkAppPropertiesSchema = {
    required: ['id', 'app_name', 'user_id', 'session_id', 'invocation_id', 'author', 'branch', 'timestamp', 'content', 'actions'],
    properties: {
        id: {
            type: 'string'
        },
