...
export const ScheduledWorkflowsSchema = {
    ...
    required: ['metadata', 'tenantId', 'workflowVersionId', 'workflowName', 'workflowId', 'triggerAt', 'method']
} as const;
...
export const CronWorkflowsSchema = {
    ...
    required: ['metadata', 'tenantId', 'workflowVersionId', 'workflowName', 'workflowId', 'cron', 'enabled', 'method']
} as const;
...
export const StepRunStatusSchema = {
    type: 'string',
    enum: ['PENDING', 'PENDING_ASSIGNMENT', 'ASSIGNED', 'RUNNING', 'SUCCEEDED', 'FAILED', 'CANCELLED', 'CANCELLING', 'BACKOFF']
} as const;
...
export const StepRunEventReasonSchema = {
    type: 'string',
    enum: ['REQUEUED_NO_WORKER', 'REQUEUED_RATE_LIMIT', 'SCHEDULING_TIMED_OUT', 'ASSIGNED', 'STARTED', 'ACKNOWLEDGED', 'FINISHED', 'FAILED', 'RETRYING', 'CANCELLED', 'TIMEOUT_REFRESHED', 'REASSIGNED', 'TIMED_OUT', 'SLOT_RELEASED', 'RETRIED_BY_USER', 'WORKFLOW_RUN_GROUP_KEY_SUCCEEDED', 'WORKFLOW_RUN_GROUP_KEY_FAILED']
} as const;
...
export const PullRequestSchema = {
    ...
    required: ['repositoryOwner', 'repositoryName', 'pullRequestID', 'pullRequestTitle', 'pullRequestNumber', 'pullRequestHeadBranch', 'pullRequestBaseBranch', 'pullRequestState']
} as const;
...
export const CustomQuickActionSchema = {
    properties: {
        id: {
            type: 'string',
            description: 'A UUID for the quick action. Used to identify the quick action.'
        },
        title: {
            type: 'string',
            description: 'The title of the quick action. Used in the UI to display the quick action.'
        },
        prompt: {
            type: 'string',
        ...
        includeReflections: {
            type: 'boolean',
            description: "Whether or not to include the user's reflections in the prompt."
        },
        includePrefix: {
            type: 'boolean',
            description: 'Whether or not to include the default prefix in the prompt.'
        },
        includeRecentHistory: {
            type: 'boolean',
            description: 'Whether or not to include the last 5 (or less) messages in the prompt.'
        }
    },
    required: ['id', 'title', 'prompt', 'includeReflections', 'includePrefix', 'includeRecentHistory']
} as const;
...
export const ProgrammingLanguageOptionsSchema = {
    type: 'string',
    enum: ['typescript', 'javascript', 'cpp', 'java', 'php', 'python', 'html', 'sql', 'json', 'rust', 'xml', 'clojure', 'csharp', 'other']
} as const;
...
export const ComponentModelSchema = {
    ...
    properties: {
        ...
        component_type: {
            type: 'string',
            description: 'Logical type of the component. If missing, the component assumes the default type of the provider.',
        ...
        component_version: {
            type: 'integer',
            description: 'Version of the component. If missing, the component assumes the default version of the provider.'
        },
        description: {
            type: 'string',
        ...
        label: {
            type: 'string',
            description: 'Human readable label for the component. If missing the component assumes the class name of the provider.'
        },
        config: {
            description: "The schema validated config field is passed to a given class's implmentation of :py:meth:`autogen_core.ComponentConfigImpl._from_config` to create a new instance of the component class."
        }
    }
} as const;
...
export const EventTypesSchema = {
    type: 'string',
    enum: ['WorkflowRunStart', 'WorkflowRunEnd', 'StepRun', 'TextMessage', 'ModelClientStreamingChunkEvent', 'EventNewAgentState']
} as const;
...
export const TerminationTypesSchema = {
    type: 'string',
    enum: ['MaxMessageTermination', 'StopMessageTermination', 'TextMentionTermination', 'TimeoutTermination']
} as const;
...
export const AgentTypesSchema = {
    type: 'string',
    enum: ['AssistantAgent', 'UserProxyAgent', 'MultimodalWebSurfer', 'FileSurfer', 'MagenticOneCoderAgent']
} as const;
...
export const AzureOpenAIModelConfigSchema = {
    allOf: [
        ...
        },
        {
            ...
            required: ['model_type', 'azure_deployment', 'api_version', 'azure_endpoint', 'azure_ad_token_provider']
        }
    ]
} as const;
...
export const RunStatusSchema = {
    type: 'string',
    enum: ['created', 'active', 'awaiting_input', 'timeout', 'complete', 'error', 'stopped']
} as const;
...
export const TeamTypesSchema = {
    type: 'string',
    enum: ['Assisant', 'RoundRobinGroupChat', 'SelectorGroupChat', 'MagenticOneGroupChat']
} as const;
...
export const AssignedActionSchema = {
    type: 'object',
    required: ['tenantId', 'jobId', 'stepId', 'actionId', 'actionType', 'actionPayload', 'stepName', 'retryCount'],
    properties: {
        tenantId: {
            type: 'string'
        },
...
export const CodeReviewTaskSchema = {
    required: ['session_id', 'code_writing_task', 'code_writing_scratchpad', 'code'],
    properties: {
        session_id: {
            type: 'string'
        },
