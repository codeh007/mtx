...
export const zCronWorkflowsOrderByField = z.enum(["createdAt"]);
...
export const zDbModel = z.object({
  id: z.number(),
  user_id: z.string(),
  created_at: z.string(),
  updated_at: z.string(),
...
export const zMessageV2 = zDbModel.merge(
  z.object({
    config: z.union([
      zTextMessageConfig,
...
export const zAgentConfig = z.union([
  zBaseConfig
    .merge(
      z.object({
        name: z.string(),
        ...
        model_client: zModelConfig,
        tools: z.array(zToolConfig),
        description: z.string(),
      }),
    )
    .merge(
...
export const zAssistantAgentConfig = zBaseConfig
  .merge(
    z.object({
      name: z.string(),
      agent_type: zAgentTypes,
...
export const zUserProxyAgentConfig = zBaseConfig
  .merge(
    z.object({
      name: z.string(),
      agent_type: zAgentTypes,
...
export const zMultimodalWebSurferAgentConfig = zBaseConfig
  .merge(
    z.object({
      name: z.string(),
      agent_type: zAgentTypes,
...
export const zFileSurferAgentConfig = zBaseConfig
  .merge(
    z.object({
      name: z.string(),
      agent_type: zAgentTypes,
...
export const zMagenticOneCoderAgentConfig = zBaseConfig
  .merge(
    z.object({
      name: z.string(),
      agent_type: zAgentTypes,
...
export const zBaseAgentConfig = zBaseConfig.merge(
  z.object({
    name: z.string(),
    agent_type: zAgentTypes,
    system_message: z.string().optional(),
...
export const zBaseTeamConfig = z.object({
  name: z.string().optional(),
  participants: z.array(zAgentConfig).optional(),
  team_type: z
...
export const zTerminationConfig: z.ZodTypeAny = z.union([
  ...
  zBaseConfig
    ...
    .merge(
      z.object({
        termination_type: z.enum(["TextMentionTermination"]),
        text: z.string(),
      }),
    ),
  zBaseConfig
    ...
    .merge(
      z.object({
        termination_type: z.enum(["CombinationTermination"]),
        operator: z.enum(["and", "or"]),
        conditions: z.array(
          z.lazy(() => {
            return zTerminationConfig;
          }),
        ),
      }),
    ),
...
export const zMaxMessageTerminationConfig = zBaseTerminationConfig.merge(
  z.object({
    termination_type: z.enum(["MaxMessageTermination"]),
    max_messages: z.number(),
  }),
...
export const zTextMentionTerminationConfig = zBaseTerminationConfig.merge(
  z.object({
    termination_type: z.enum(["TextMentionTermination"]),
    text: z.string(),
  }),
...
export const zCombinationTerminationConfig = zBaseTerminationConfig.merge(
  z.object({
    termination_type: z.enum(["CombinationTermination"]),
    operator: z.enum(["and", "or"]),
    conditions: z.array(zTerminationConfig),
  }),
);
