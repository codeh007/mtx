...
export const zChatMessageRole = z.enum([
    'system',
    'user',
    'assistant'
]);
...
export const zStartWorkflowRunEvent = zEventBase.merge(z.object({
    workflowRunId: z.string().optional()
}));
...
export const zTextMessageConfig = zBaseMessageConfig.merge(z.object({
    content: z.string().optional()
}));

export const zMultiModalMessageConfig = zBaseMessageConfig.merge(z.object({
    content: z.array(z.unknown()).optional()
}));
...
export const zBaseModelConfig = zComponentModel.merge(z.object({
    model: z.string(),
...
export const zAzureOpenAiModelConfig = zBaseModelConfig.merge(z.object({
    model_type: z.enum([
        'AzureOpenAIChatCompletionClient'
    ]),
...
export const zOpenAiModelConfig = zBaseModelConfig.merge(z.object({
    model_type: z.enum([
        'OpenAIChatCompletionClient'
    ])
}));
...
export const zToolComponent = zComponentModel.merge(z.object({
    config: zComponentModel.merge(z.object({
        name: z.string(),
        description: z.string(),
        content: z.string(),
...
export const zToolConfig = zComponentModel.merge(z.object({
    name: z.string(),
    description: z.string(),
    content: z.string(),
    tool_type: zToolTypes,
...
export const zAgentConfig = zComponentModel.merge(z.object({
    name: z.string(),
    description: z.string().optional(),
    agent_type: zAgentTypes,
    system_message: z.string().optional(),
...
export const zAssistantAgentConfig = zAgentConfig.merge(z.object({
...
export const zSelectorGroupChatConfig = zComponentModel.merge(z.object({
    team_type: z.enum([
        'SelectorGroupChat'
    ]).optional(),
...
export const zTerminationComponent = zComponentModel.merge(z.object({
    config: z.object({
        termination_type: zTerminationTypes.optional(),
        conditions: z.array(z.union([
            zComponentModel.merge(z.object({
...
export const zAssisantState = zBaseState.merge(z.object({
    name: z.string(),
    description: z.string()
}));

export const zGenArticleState = zBaseState.merge(z.object({
    topic: z.string(),
    prompt: z.string().optional(),
    title: z.string().optional(),
    subTitle: z.string().optional(),
