...
export const zSelectorGroupChatComponent = z
  ...
  .merge(
    z.object({
      provider: z.enum(["autogen_agentchat.teams.SelectorGroupChat"]),
      config: z
        .object({
...
export const zSmolaAgentComponent = z
  .object({
    id: z.string().optional(),
    provider: z.string(),
    componentType: z.enum(["team", "agent", "model", "tool", "termination"]),
...
export const zSmolaAgentConfig = z
  .object({
    name: z.string(),
    description: z.string(),
    model_context: z.object({}).optional(),
...
export const zParticipantsProperty = z.union([
  z
    .object({
      id: z.string().optional(),
      provider: z.string(),
...
export const zMtComponent = zApiResourceMetaProperties
  .merge(
    z.union([
      z
        .object({
...
export const zMtComponentProperties = z.union([
  z
    .object({
      id: z.string().optional(),
      provider: z.string(),
...
export const zRoundRobinGroupChatConfig = zTeamConfigBase.merge(
  z.object({
    ...
    termination_condition: zComponentModel.merge(
      z.object({
        componentType: z.enum(["termination"]),
        provider: z.enum([
          "autogen_agentchat.conditions.TextMentionTermination",
...
export const zSelectorGroupChatConfig = zTeamConfigBase
  .merge(zRoundRobinGroupChatConfig)
  .merge(
    z.object({
      participants: z.array(
        zComponentModel.merge(
...
export const zInstagramTeamComponent = zComponentModel.merge(
  z.object({
    provider: z.enum(["mtmai.teams.instagram_team.InstagramTeam"]),
    config: zTeamConfigBase.merge(
      z.object({
