...
export const zTeamState = zBaseState.merge(z.object({
    type: z.enum([
        'TeamState'
    ]).optional(),
    agent_states: z.unknown().optional()
...
export const zRoundRobinManagerState = zBaseState.merge(z.object({
    type: z.enum([
        'BaseGroupChatManagerState'
    ]).optional(),
    message_thread: z.array(z.union([
...
export const zSelectorManagerState = zBaseState.merge(z.object({
    type: z.enum([
        'SelectorManagerState'
    ]).optional(),
    previous_speaker: z.string().optional()
...
export const zSwarmManagerState = zBaseState.merge(z.object({
    type: z.enum([
        'SwarmManagerState'
    ]).optional(),
    current_speaker: z.string().optional()
...
export const zMagenticOneOrchestratorState = zBaseState.merge(z.object({
    type: z.enum([
        'MagenticOneOrchestratorState'
    ]).optional(),
    task: z.string().optional(),
...
export const zSocietyOfMindAgentState = zBaseState.merge(z.object({
    type: z.enum([
        'SocietyOfMindAgentState'
    ]).optional(),
    inner_team_state: z.unknown().optional()
...
export const zMtComponent = zApiResourceMetaProperties.merge(zMtComponentProperties);
...
export const zAzureOpenAiModelConfig = z.object({
    model: z.string(),
    model_type: z.enum([
        'OpenAIChatCompletionClient',
        'AzureOpenAIChatCompletionClient'
...
export const zOpenAiModelConfig = z.object({
    model: z.string(),
    model_type: z.enum([
        'OpenAIChatCompletionClient',
        'AzureOpenAIChatCompletionClient'
...
export const zSelectorGroupChatConfig = zRoundRobinGroupChatConfig.merge(z.object({
    participants: z.array(zMtComponent),
    termination_condition: zMtComponent,
