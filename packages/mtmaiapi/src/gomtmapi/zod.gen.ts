...
export const zWorkflowWorkersCount = z.object({
    ...
    other: z.union([
        ...
        z.object({
            ...
            init_state: z.union([
                ...
                z.object({
                    ...
                    message_thread: z.array(z.union([
                        z.object({
                            type: z.literal('ThoughtEvent').optional()
                        }).merge(z.object({
                            type: z.string(),
        ...
        z.object({
            ...
            video_materials: z.array(z.object({
                provider: z.string().optional(),
                url: z.string().optional(),
...
export const zRootAgentState = z.object({
    type: z.enum([
        'InstagramAgentState',
        'SocialTeamManagerState',
        'TeamState',
...
export const zAssistantAgentState = zBaseState.merge(z.object({
    type: z.enum([
        'AssistantAgentState'
    ]),
    llm_context: z.unknown().optional()
...
export const zInstagramAgentState = zBaseState.merge(z.object({
    type: z.enum([
        'InstagramAgentState'
    ]),
    llm_context: z.unknown().optional(),
...
export const zBaseGroupChatManagerState = zBaseState.merge(z.object({
    type: z.enum([
        'BaseGroupChatManagerState'
    ]).optional(),
...
export const zAgentStates = z.union([
    ...
    z.object({
        type: z.literal('SocialTeamManagerState').optional()
    }).merge(zBaseState.merge(z.object({
        type: z.enum([
            'SocialTeamManagerState'
        ]),
        next_speaker_index: z.number().int().optional().default(0),
...
export const zSocialTeamManagerState = zBaseState.merge(z.object({
    type: z.enum([
        'SocialTeamManagerState'
    ]),
    next_speaker_index: z.number().int().optional().default(0),
...
export const zChatAgentContainerState = zBaseState.merge(z.object({
    type: z.enum([
        'ChatAgentContainerState'
    ]),
    agent_state: z.object({}).optional(),
...
export const zMessageThread = z.array(z.union([
    z.object({
        type: z.literal('ThoughtEvent').optional()
    }).merge(z.object({
        type: z.string(),
...
export const zComponent = zApiResourceMetaProperties.merge(z.object({
    label: z.string(),
    description: z.string(),
    provider: z.string(),
...
export const zAssistantAgent = z.object({
    provider: z.string().optional(),
    component_type: z.string().optional(),
    version: z.number().int().optional(),
    component_version: z.number().int().optional(),
...
export const zCodeExecutorAgent = zAssistantAgent.merge(z.object({
    config: z.object({
        provider: z.enum([
            'CodeExecutorAgent'
        ]),
...
export const zSocietyOfMindAgent = zAssistantAgent.merge(z.object({
    config: z.object({
        code: z.string(),
        provider: z.enum([
            'SocietyOfMindAgent'
...
export const zUserProxyAgent = z.object({
    provider: z.string().optional(),
    component_type: z.string().optional(),
    version: z.number().int().optional(),
    component_version: z.number().int().optional(),
...
export const zAgents = z.union([
    ...
    z.object({
        ...
        config: zAssistantAgentConfig.merge(z.object({
            credentials: zInstagramCredentials.optional(),
            proxy_url: z.string().optional()
        }))
    }))),
...
export const zOpenAiClientConfigurationConfigModel = z.object({
    frequency_penalty: z.number().optional(),
    logit_bias: z.object({}).optional(),
    max_tokens: z.number().int().optional(),
    n: z.number().int().optional(),
...
export const zBaseOpenAiClientConfigurationConfigModel = z.object({
    frequency_penalty: z.number().optional(),
    logit_bias: z.object({}).optional(),
    max_tokens: z.number().int().optional(),
    n: z.number().int().optional(),
...
export const zModel = zApiResourceMetaProperties.merge(z.object({
    name: z.string(),
    model: z.string(),
    provider: z.string(),
    apiKey: z.string(),
...
export const zTeamComponent = zComponentModel.merge(z.object({
    component_type: z.enum([
        'team'
    ])
}));

export const zSocialTeamConfig = zTeamConfig.merge(z.object({
    selector_prompt: z.string().optional(),
    allow_repeated_speaker: z.boolean().optional(),
    max_selector_attempts: z.number().int().optional(),
    selector_func: z.string().optional(),
...
export const zSocialTeam = zTeamComponent.merge(z.object({
    provider: z.enum([
        'SocialTeam'
    ]),
    component_type: z.enum([
...
export const zStructuredMessage = zBaseChatMessage.merge(z.object({
    type: z.enum([
        'StructuredMessage'
    ]),
    content: z.string()
...
export const zMultiModalMessage = zBaseChatMessage.merge(z.object({
    type: z.enum([
        'MultiModalMessage'
    ]),
    content: z.string()
...
export const zHandoffMessage = zBaseTextChatMessage.merge(z.object({
    type: z.enum([
        'HandoffMessage'
    ]),
...
export const zAgentIncomingEvent = z.enum([
    'YES',
    'NO'
]);
...
export const zAgentApprovalEvent = z.enum([
    'YES',
    'NO'
]);
...
export const zAdkRawEvent = z.object({
    grounding_metadata: z.object({}).optional(),
    partial: z.boolean().optional().default(false),
    turn_complete: z.boolean().optional().default(false),
    error_code: z.string().optional(),
...
export const zInstagramAgent = zComponentModel.merge(z.object({
    provider: z.enum([
        'InstagramAgent'
    ]),
    config: zAssistantAgentConfig.merge(z.object({
...
export const zInstagramAgentConfig = zAssistantAgentConfig.merge(z.object({
    credentials: zInstagramCredentials.optional(),
    proxy_url: z.string().optional()
}));

export const zOpenAiChatCompletionClient = zComponentModel.merge(z.object({
    provider: z.enum([
        'OpenAIChatCompletionClient'
    ]),
...
export const zAdkEventOrderByField = z.enum([
    'createdAt'
]);
...
export const zAdkAppTypes = z.enum([
    'root',
    'instagram_agent',
    'assistant',
    'open_deep_research'
...
export const zVideoAspect = z.enum([
    '16:9',
    '9:16',
    '1:1'
]);
