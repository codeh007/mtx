...
export const zListApiMetaIntegration = z.array(z.object({
    name: z.string(),
    enabled: z.boolean()
}));
...
export const zEventOrderByField = z.enum([
    'createdAt'
]);

export const zEventOrderByDirection = z.enum([
    'asc',
    'desc'
]);
...
export const zRateLimitOrderByDirection = z.enum([
    'asc',
    'desc'
]);
...
export const zCronWorkflowsOrderByField = z.enum([
    'name',
    'createdAt'
]);
...
export const zWorkflowRunOrderByDirection = z.enum([
    'ASC',
    'DESC'
]);
...
export const zWorkerList = z.object({
    ...
    rows: z.array(z.object({
        ...
        recentStepRuns: z.array(z.object({
            metadata: zApiResourceMeta,
            actionId: z.string(),
            status: zStepRunStatus,
            startedAt: z.string().datetime().optional(),
...
export const zPullRequestState = z.enum([
    'open',
    'closed'
]);
...
export const zLogLineOrderByField = z.enum([
    'createdAt'
]);

export const zLogLineOrderByDirection = z.enum([
    'asc',
    'desc'
]);
...
export const zOperationEnum = z.enum([
    'startBlogTask',
    'stopBlogTask'
]);
...
export const zSelectorGroupChatComponent = z.object({
    provider: z.string(),
    ...
    config: z.object({
        ...
        termination_condition: z.object({
            provider: z.string(),
            componentType: z.enum([
                'team',
                'agent',
...
export const zRoundRobinGroupChatComponent = z.object({
    provider: z.string(),
    componentType: z.enum([
        'team',
        'agent',
...
export const zTeamConfigBase = z.object({
    participants: z.array(z.object({
        provider: z.string(),
        componentType: z.enum([
            'team',
...
export const zAgStateUpsert = zAgStateProperties.merge(z.object({
...
export const zMtComponent = zApiResourceMetaProperties.merge(z.object({
    componentType: z.enum([
        'team',
        'agent',
        'model',
...
export const zOrTerminationComponent = zComponentModel.merge(z.object({
    componentType: z.enum([
        'termination'
    ]),
    config: z.object({
...
export const zTenantComponent = zComponentModel.merge(z.object({
    provider: z.enum([
        'mtmai.tenant.Tenant'
    ]),
    config: z.object({
...
export const zSystemComponent = zComponentModel.merge(z.object({
    provider: z.enum([
        'mtmai.system.System'
    ]),
    config: z.object({
...
export const zStopMessageConfig = zBaseMessageConfig.merge(z.object({
    content: z.string()
}));

export const zHandoffMessageConfig = zBaseMessageConfig.merge(z.object({
    content: z.string(),
    target: z.string()
}));

export const zToolCallMessageConfig = zBaseMessageConfig.merge(z.object({
    content: z.array(zFunctionCall)
}));

export const zToolCallResultMessageConfig = zBaseMessageConfig.merge(z.object({
...
export const zToolTypes = z.enum([
    'PythonFunction'
]);
...
export const zModelFamily = z.enum([
    'r1',
    'openai',
    'unknown'
]);
...
export const zAzureOpenAiModelConfig = zModelConfig.merge(z.object({
    model_type: z.enum([
        'AzureOpenAIChatCompletionClient'
    ]),
...
export const zOpenAiModelConfig = zModelConfig.merge(z.object({
    model_type: z.enum([
        'OpenAIChatCompletionClient'
    ])
}));

export const zToolComponent = zComponentModel.merge(z.object({
    componentType: z.enum([
        'tool'
    ]),
    config: z.object({
...
export const zHandoffComponent = zComponentModel.merge(z.object({
    target: z.string()
}));
...
export const zModelComponent = zComponentModel.merge(z.object({
    componentType: z.enum([
        'model'
    ]),
    config: zModelConfig
...
export const zResponseFormat = z.enum([
    'json_object',
    'text'
]);
...
export const zRoundRobinGroupChatConfig = zTeamConfigBase.merge(z.object({
    participants: z.array(zComponentModel.merge(z.object({
        componentType: z.enum([
            'agent'
        ]),
        config: z.object({
    ...
    termination_condition: zComponentModel.merge(z.object({
        componentType: z.enum([
            'termination'
        ]),
        provider: z.enum([
...
export const zSelectorGroupChatConfig = zTeamConfigBase.merge(z.object({
    participants: z.array(zComponentModel.merge(z.object({
        componentType: z.enum([
            'agent'
        ]),
...
export const zMaxMessageTerminationConfigComponent = zComponentModel.merge(z.object({
    componentType: z.enum([
        'termination'
    ]),
    provider: z.enum([
...
export const zTextMentionTerminationComponent = zComponentModel.merge(z.object({
    componentType: z.enum([
        'termination'
    ]),
    provider: z.enum([
...
export const zInstagramAgentComponent = zComponentModel.merge(z.object({
    componentType: z.enum([
        'agent'
    ]),
    config: z.object({
...
export const zMtResource = zApiResourceMetaProperties.merge(zMtResourceProperties);
...
export const zMtResourceUpsert = zApiResourceMetaProperties.merge(zMtResourceProperties);
...
export const zInstagramTeamComponent = zComponentModel.merge(z.object({
    provider: z.enum([
        'mtmai.teams.instagram_team.InstagramTeam'
    ]),
    config: zTeamConfigBase.merge(z.object({
        participants: z.array(zInstagramAgentComponent),
        termination_condition: zOrTerminationComponent
    }))
}));

export const zInstagramTeamConfig = zTeamConfigBase.merge(z.object({
    participants: z.array(zInstagramAgentComponent),
    termination_condition: zOrTerminationComponent
}));
...
export const zAgentComponent = zComponentModel.merge(z.object({
    componentType: z.enum([
        'agent'
    ]),
    config: z.object({
