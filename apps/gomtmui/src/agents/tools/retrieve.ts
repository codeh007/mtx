...
async function fetchJinaReaderData(url: string): Promise<SearchResultsType | null> {
  try {
...
async function fetchTavilyExtractData(url: string): Promise<SearchResultsType | null> {
  try {
