...
import { siteGetOptions, siteUpdateMutation } from "mtmaiapi/gomtmapi/@tanstack/react-query.gen";
      ...
      <Tabs defaultValue="general" className="w-full">
              ...
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm text-muted-foreground">
                      {siteData.automation_enabled ? "自动化已启用" : "手动模式"}
                    </span>
                  </div>
                  ...
                  <div className="flex justify-end">
                    <Button
                      type="submit"
                      disabled={updateSiteMutation.isPending || !form.formState.isDirty}
                    >
        ...
        <TabsContent value="hosts">
          <Card>
            ...
            <CardContent>
              <div className="text-center py-6 text-muted-foreground">域名管理功能暂未实现</div>
            </CardContent>
          </Card>
        </TabsContent>
        <TabsContent value="settings">
          <Card>
            ...
            <CardContent>
              <div className="text-center py-6 text-muted-foreground">高级设置功能暂未实现</div>
            </CardContent>
          </Card>
        </TabsContent>
      </Tabs>
