...
import type { WorkflowDefinition } from "mtmaiapi";
...
import { type LoopNode, loopNodeDefaultData } from "./nodes/LoopNode/types";
import type { NodeAdderNode } from "./nodes/NodeAdderNode/types";
import { sendEmailNodeDefaultData } from "./nodes/SendEmailNode/types";
import type { StartNode } from "./nodes/StartNode/types";
...
function getElements(blocks: Array<WorkflowDefinition["blocks"]>): {
  nodes: Array<AppNode>;
  edges: Array<Edge>;
} {
