...
app.get("/authorize", async (c) => {
  ...
  if (await clientIdAlreadyApproved(c.req.raw, oauthReqInfo.clientId, COOKIE_ENCRYPTION_KEY)) {
...
app.post("/authorize", async (c) => {
  ...
  const { state, headers } = await parseRedirectApproval(c.req.raw, COOKIE_ENCRYPTION_KEY);
