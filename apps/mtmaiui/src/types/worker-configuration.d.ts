/* eslint-disable */
// Generated by Wrangler by running `wrangler types --path ./src/types/worker-configuration.d.ts` (hash: 3bc5cbd0934046194f25bc58148efea5)
// Runtime types generated with workerd@1.20250416.0 2025-03-10 nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
	interface Env {
		OAUTH_KV: KVNamespace;
		D1_REST_API_TOKEN: "d1_rest_api_token";
		AGENT_RUNNER_URL: "http://localhost:7860";
		MTMAG_DATABASE_URL: "postgresql://postgres:postgres@localhost:5432/postgres";
		SECRET_TOKEN: "my-local-secret-token";
		NONROOT_USER: string;
		DEFAULT_PASSWORD: string;
		MTM_ADMIN_TOKEN: string;
		PIPY_TOKEN: string;
		NPM_TOKEN: string;
		POETRY_PYPI_TOKEN_PYPI: string;
		SSH_AUTHKEYS: string;
		ID_ED25519_PUB: string;
		SECRET_KEY: string;
		MTMAI_BACKEND: string;
		MTM_SERVER_URL: string;
		MTMAIUI_URL: string;
		DISPLAY: string;
		SERVER_TASKQUEUE_KIND: string;
		CF_AGENT_ENDPOINT: string;
		GITHUB_APP_ID: string;
		GITHUB_CLIENT_ID: string;
		GITHUB_CLIENT_SECRET: string;
		MAIN_GH_TOKEN: string;
		MAIN_GH_USER: string;
		...
		OTEL_PYTHON_LOGGING_AUTO_INSTRUMENTATION_ENABLED: string;
		...
		HUGGINGFACEHUB_USER: string;
		HUGGINGFACEHUB_API_TOKEN: string;
		HUGGINGFACEHUB_DEFAULT_WORKSPACE: string;
		TEMBO_TOKEN: string;
		TEMBO_ORG: string;
		TEMBO_INST: string;
		GROQ_TOKEN: string;
		SEARXNG_URL_BASE: string;
		SERPER_DEV_TOKEN: string;
		CHAINLIT_AUTH_SECRET: string;
		...
		GOOGLE_AI_STUDIO_API_KEY_2: string;
		...
		Scheduler: DurableObjectNamespace<import("../server").Scheduler>;
		EmailAgent: DurableObjectNamespace<import("../server").EmailAgent>;
		MyMcpAgent: DurableObjectNamespace<import("../server").MyMcpAgent>;
		RootAg: DurableObjectNamespace<import("../server").RootAg>;
		DemoMcpServer: DurableObjectNamespace<import("../server").DemoMcpServer>;
		WorkerAgent: DurableObjectNamespace<import("../server").WorkerAgent>;
		ShortVideoAg: DurableObjectNamespace<import("../server").ShortVideoAg>;
		MY_BUCKET: R2Bucket;
		VECTORIZE: VectorizeIndex;
		HYPERDRIVE: Hyperdrive;
		AI: Ai;
		BACKUP_WORKFLOW: Workflow;
		PROMPT_CHAINING_WORKFLOW: Workflow;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "D1_REST_API_TOKEN" | "AGENT_RUNNER_URL" | "MTMAG_DATABASE_URL" | "SECRET_TOKEN" | "NONROOT_USER" | "DEFAULT_PASSWORD" | "MTM_ADMIN_TOKEN" | "PIPY_TOKEN" | "NPM_TOKEN" | "POETRY_PYPI_TOKEN_PYPI" | "SSH_AUTHKEYS" | "ID_ED25519_PUB" | "SECRET_KEY" | "MTMAI_BACKEND" | "MTM_SERVER_URL" | "MTMAIUI_URL" | "DISPLAY" | "SERVER_TASKQUEUE_KIND" | "CF_AGENT_ENDPOINT" | "GITHUB_APP_ID" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "MAIN_GH_TOKEN" | "MAIN_GH_USER" | "GOOGLE_APP_ID" | "GOOGLE_APP_SECRET" | "VERCEL_TOKEN" | "VERCEL_ORG_ID" | "DOCKERHUB_USER" | "DOCKERHUB_PASSWORD" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_API_EMAIL" | "CLOUDFLARE_API_TOKEN" | "CLOUDFLARE_AI_TOKEN" | "CLOUDFLARE_R2_ENDPOINT" | "CLOUDFLARE_R2_TOKEN" | "CLOUDFLARE_R2_ACCESS_KEY" | "CLOUDFLARE_R2_SECRET_KEY" | "CLOUDFLARE_R2_BUCKET" | "MTM_DATABASE_URL" | "WRANGLER_HYPERDRIVE_LOCAL_CONNECTION_STRING_HYPERDRIVE" | "KOYEB_TOKEN" | "CF_TUNNEL_TOKEN" | "TOGETHER_API_KEY" | "TAVILY_API_KEY" | "OTEL_LOGS_EXPORTER" | "OTEL_PYTHON_LOGGING_AUTO_INSTRUMENTATION_ENABLED" | "OTEL_EXPORTER_OTLP_PROTOCOL" | "OTEL_EXPORTER_OTLP_ENDPOINT" | "OTEL_EXPORTER_OTLP_HEADERS" | "OTEL_SERVICE_NAME" | "LOKI_ENDPOINT" | "LOKI_USER" | "GRAFANA_TOKEN" | "OPENAI_API_KEY" | "OPENAI_API_BASE" | "OPENAI_MODEL" | "NODE_TLS_REJECT_UNAUTHORIZED" | "HUGGINGFACEHUB_USER" | "HUGGINGFACEHUB_API_TOKEN" | "HUGGINGFACEHUB_DEFAULT_WORKSPACE" | "TEMBO_TOKEN" | "TEMBO_ORG" | "TEMBO_INST" | "GROQ_TOKEN" | "SEARXNG_URL_BASE" | "SERPER_DEV_TOKEN" | "CHAINLIT_AUTH_SECRET" | "LANGCHAIN_TRACING_V2" | "LANGCHAIN_ENDPOINT" | "LANGCHAIN_API_KEY" | "LANGCHAIN_PROJECT" | "PREFECT_API_KEY" | "NVIDIA_API_KEY" | "LOKI_URL" | "LOKI_USERNAME" | "LOKI_PASSWORD" | "TAILSCALE_AUTH_KEY" | "TAILSCALE_API_KEY" | "HF_SPACE" | "HF_TOKEN" | "OPENROUTER_API_KEY" | "WEATHER_API_KEY" | "GOOGLE_AI_STUDIO_API_KEY" | "GOOGLE_AI_STUDIO_API_KEY_2" | "GOOGLE_GENERATIVE_AI_API_KEY" | "GEMINI_API_KEY" | "JINA_API_KEY" | "SERPER_API_KEY" | "AUTH_SECRET" | "AUTH_URL" | "TWITTER_CLIENT_ID" | "TWITTER_CLIENT_SECRET" | "INSTAGRAM_CLIENT_ID" | "INSTAGRAM_CLIENT_SECRET" | "PEXELS_API_KEYS">> {}
}
