/* eslint-disable */
// Generated by Wrangler by running `wrangler types --path ./src/worker-configuration.d.ts` (hash: 505bfb77a59c94701c1c5ceab25f0398)
// Runtime types generated with workerd@1.20250416.0 2025-03-10 nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
  interface Env {
    OAUTH_KV: KVNamespace;
    GITHUB_CLIENT_ID: "<YOUR_GITHUB_CLIENT_ID>" | "<YOUR_GITHUB_CLIENT_ID2>";
    GITHUB_CLIENT_SECRET: "<YOUR_GITHUB_CLIENT_SECRET>" | "<YOUR_GITHUB_CLIENT_SECRET2>";
    ...
    MyMcpAgent: DurableObjectNamespace /* MyMcpAgent */;
    RootAg: DurableObjectNamespace /* RootAg */;
