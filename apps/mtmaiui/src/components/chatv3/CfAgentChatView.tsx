      ...
      <div className="h-[calc(100vh-0.5rem)] w-full mx-auto max-w-lg flex flex-col shadow-xl rounded-md overflow-hidden relative border border-neutral-300 dark:border-neutral-800">
        <div className="px-4 py-3 border-b border-neutral-300 dark:border-neutral-800 flex items-center gap-3 sticky top-0 z-10">
          ...
          <div className="flex items-center gap-2 mr-2">
            ...
            <BetterTooltip content="Auto Task Dispatch">
            ...
            <Switch
              aria-label="enabled auto tasks dispatch"
              checked={!!agentState?.enabledAutoDispatch}
              onCheckedChange={() => {
                agent.setState({
                  ...agentState,
                  enabledAutoDispatch: !agentState?.enabledAutoDispatch,
                });
              }}
            />
          </div>
