/* eslint-disable */
// Generated by Wrangler by running `wrangler types --path ./src/worker-configuration.d.ts` (hash: b3f27e3870234cd1351d595e272fe63c)
...
declare namespace Cloudflare {
	interface Env {
		...
		MTM_DATABASE_URL_DEV: string;
		MTMAI_DATABASE_URL: string;
		SERVER_MSGQUEUE_RABBITMQ_URL: string;
		SESSION_DB_URL: string;
		WRANGLER_HYPERDRIVE_LOCAL_CONNECTION_STRING_HYPERDRIVE: string;
		MTMAG_DATABASE_URL: string;
		KOYEB_TOKEN: string;
		CF_TUNNEL_TOKEN: string;
		CF_TUNNEL_TOKEN_TEMBO: string;
