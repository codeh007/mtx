/* eslint-disable */
// Generated by Wrangler by running `wrangler types --path ./src/worker-configuration.d.ts` (hash: 6f78eb422ca6dc04fbe77fb31ad8bbc1)
...
declare namespace Cloudflare {
	interface Env {
		...
		Stateful: DurableObjectNamespace<import("./server").Stateful>;
